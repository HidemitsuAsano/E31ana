#!/bin/tcsh -f
set Version="1"
set DATADIR="/gpfs/group/had/knucl/e15/asano/sim/simnpipiL_br0${Version}/"
...
set OUTDIRSUB="${OUTDIR}simDSTnpipiL_br0${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set OUTFILE=${OUTDIRSUB}"/simDST_npipiL_0${jobnum}.root"

  echo ${INPFILE}
  echo ${OUTFILE}

  set lognamesp = "${logdir}/runnpipiL_br0$i.log"
  bsub -o $lognamesp -q s ${EXEC___} ${CONF___} ${OUTFILE} ${INPFILE} 
    @ i ++
end
