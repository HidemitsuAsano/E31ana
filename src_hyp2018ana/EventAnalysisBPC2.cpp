...
class EventAnalysisBPC2: public EventTemp
{
public:
  EventAnalysisBPC2();
  ~EventAnalysisBPC2();
...
EventAnalysisBPC2::EventAnalysisBPC2()
  : EventTemp()
{
}
...
void EventAnalysisBPC2::Initialize( ConfMan *conf )
{
  confMan = conf;
  ...
  histMan = new HistManBPC2(rtFile);
...
void EventAnalysisBPC2::USca( int nsca, unsigned int *sca )
{
  Block_Event_Number++;
...
bool EventAnalysisBPC2::UAna( TKOHitCollection *tko )
{
  Event_Number++;
...
void EventAnalysisBPC2::Finalize()
{
...
{
  EventAnalysisBPC2 *event = new EventAnalysisBPC2();
