...
class EventAnalysisReadCalibCDC : public EventTemp
{
public:
  EventAnalysisReadCalibCDC();
  ~EventAnalysisReadCalibCDC(){};
private:
  int t0, t1;
...
EventAnalysisReadCalibCDC::EventAnalysisReadCalibCDC() : EventTemp()
{
}

bool EventAnalysisReadCalibCDC::UAna(TKOHitCollection *tko)
{
  Event_Number++;
...
void EventAnalysisReadCalibCDC::Initialize(ConfMan *conf)
{
  confMan = conf;
...
bool EventAnalysisReadCalibCDC::cdsFileMatching()
{
...
bool EventAnalysisReadCalibCDC::anaFileMatching()
{
...
bool EventAnalysisReadCalibCDC::Clear(bool flag)
{
  header-> Clear();
  blMan-> Clear();
  cdsMan-> Clear();
...
void EventAnalysisReadCalibCDC::USca(int nsca, unsigned int *sca)
{
  Block_Event_Number++;
...
void EventAnalysisReadCalibCDC::Finalize()
{
  delete blMan;
  delete cdsMan;
  delete cdsHeader;
