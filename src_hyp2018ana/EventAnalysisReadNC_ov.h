...
class EventAnalysisReadNC_ov : public EventTemp
{
public:
  EventAnalysisReadNC_ov();
  ~EventAnalysisReadNC_ov(){};
private:
  int t0, t1;
...
EventAnalysisReadNC_ov::EventAnalysisReadNC_ov() : EventTemp()
{
}

bool EventAnalysisReadNC_ov::UAna(TKOHitCollection *tko)
{
  Event_Number++;
...
void EventAnalysisReadNC_ov::Initialize(ConfMan *conf)
{
  confMan = conf;
...
bool EventAnalysisReadNC_ov::cdsFileMatching()
{
...
bool EventAnalysisReadNC_ov::anaFileMatching()
{
...
bool EventAnalysisReadNC_ov::Clear(bool flag)
{
  header-> Clear();
  blMan-> Clear();
  cdsMan-> Clear();
...
void EventAnalysisReadNC_ov::USca(int nsca, unsigned int *sca)
{
  Block_Event_Number++;
...
void EventAnalysisReadNC_ov::Finalize()
{
  delete blMan;
  delete cdsMan;
  delete cdsHeader;
