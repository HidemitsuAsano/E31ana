...
class EventAnalysisChargedMode : public EventTemp
{
public:
  EventAnalysisChargedMode();
  ~EventAnalysisChargedMode(){};
private:
  int t0, t1;
...
EventAnalysisChargedMode::EventAnalysisChargedMode() : EventTemp()
{
}

bool EventAnalysisChargedMode::UAna(TKOHitCollection *tko)
{
  Event_Number++;
...
void EventAnalysisChargedMode::Initialize(ConfMan *conf)
{
  confMan = conf;
...
bool EventAnalysisChargedMode::cdsFileMatching()
{
...
bool EventAnalysisChargedMode::anaFileMatching()
{
...
bool EventAnalysisChargedMode::Clear(bool flag)
{
  header-> Clear();
  blMan-> Clear();
  cdsMan-> Clear();
...
void EventAnalysisChargedMode::USca(int nsca, unsigned int *sca)
{
  Block_Event_Number++;
...
void EventAnalysisChargedMode::Finalize()
{
  delete blMan;
  delete cdsMan;
  delete cdsHeader;
