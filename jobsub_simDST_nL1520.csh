#!/bin/tcsh -f
set Version="1"
set DATADIR="/gpfs/group/had/knucl/e15/asano/sim/simnL1520${Version}/"
...
set OUTDIRSUB="${OUTDIR}simDSTnL1520${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set OUTFILE=${OUTDIRSUB}"/simDST_nL1520_0${jobnum}.root"

  echo ${INPFILE}
  echo ${OUTFILE}

  set logname = "${logdir}/runnL1520$i.log"
