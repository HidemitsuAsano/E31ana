#!/bin/tcsh -f
set Version="1"
set DATADIR="/gpfs/group/had/knucl/e15/asano/sim/sim_S0pipi_ns${Version}/"
...
set OUTDIRSUB="${OUTDIR}simDST_S0pipi_ns${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set INPFILE=${DATADIR}"sim_S0pippim_ns_0${jobnum}.root"
  
  set OUTFILE=${OUTDIRSUB}"/simDST_S0pippim_ns_0${jobnum}.root"

  echo ${INPFILE}
  echo ${OUTFILE}

  set logname = "${logdir}/run_S0pippim_ns_$i.log"
