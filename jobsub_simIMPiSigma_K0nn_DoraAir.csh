...
set logdir="${logbasedir}${date}_simIMPiSigma_K0nn_DoraAir_${Version}"
...
ln -s $OUTDIRSUB/simIMpisigma_K0nn_all.root simpost/simIMpisigma_K0nn_DoraAir_v${Version}.root
ln -s $OUTDIRSUB/simIMpisigma_K0nn_pippimn_all.root simpost/simIMpisigma_K0nn_pippimn_DoraAir_v${Version}.root
