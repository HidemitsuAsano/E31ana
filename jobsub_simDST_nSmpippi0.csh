#!/bin/tcsh -f
set Version="2"
set DATADIR="/gpfs/group/had/knucl/e15/asano/sim/simSmpippi0${Version}/"
...
set OUTDIRSUB="${OUTDIR}simDST_simSmpippi0${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set INPFILE=${DATADIR}"sim_nSmpippi0_0${jobnum}.root"
  
  set OUTFILE=${OUTDIRSUB}"/simDST_nSmpippi0_0${jobnum}.root"

  echo ${INPFILE}
  echo ${OUTFILE}

  set logname = "${logdir}/run_nSmpippi0$i.log"
