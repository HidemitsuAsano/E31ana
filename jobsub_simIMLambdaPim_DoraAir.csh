...
set logdir="${logbasedir}${date}_simIMLpim_DoraAir_${Version}"
...
ln -s $OUTDIRSUB/simIMLpim_all.root simpost/simIMLpim_DoraAir_v${Version}.root
ln -s $OUTDIRSUB/simIMLpim_ppimpim_all.root simpost/simIMLpim_ppimpim_DoraAir_v${Version}.root
