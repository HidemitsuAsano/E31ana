...
set logdir="${logbasedir}${date}_simIMPiSigma_Sppim_ns_${Version}"
...
ln -s $OUTDIRSUB/simIMpisigma_Sppim_ns_all.root simpost/simIMpisigma_Sppim_ns_v${Version}.root
ln -s $OUTDIRSUB/simIMpisigma_Sppim_ns_pippimn_all.root simpost/simIMpisigma_Sppim_ns_pippimn_v${Version}.root
