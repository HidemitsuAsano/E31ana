...
set Version="2"
set DSTVersion="1"
set DATADIR="/gpfs/group/had/knucl/e15/asano/sim/simK0n${DSTVersion}/"
set CDSDIR="/gpfs/group/had/knucl/e15/asano/sim/simcds/"
set CDSDIRSUB="${CDSDIR}simDSTK0n${DSTVersion}"
set OUTDIR="/gpfs/group/had/knucl/e15/asano/sim/simIMSigma_H2_K0n/"
...
cp hadd_simhist_h2_K0n.csh $OUTDIRSUB/
cp hadd_sim_h2_K0n_npi.csh $OUTDIRSUB/
ln -s $OUTDIRSUB/simIMsigma_H2_K0n_all.root simpost/simIMsigma_H2_K0n_v${Version}.root
ln -s $OUTDIRSUB/simIMsigma_H2_K0n_npi_all.root simpost/simIMsigma_H2_K0n_npi_v${Version}.root
...
while ($i < 400)   
  ...
  set INPFILESP=${DATADIR}"sim_K0n_0${jobnum}.root"
  
  set CDSFILESP=${CDSDIRSUB}"/simDST_K0n_0${jobnum}.root"
  
  set OUTFILESP=${OUTDIRSUB}"/simIMsigma_H2_K0n_0${jobnum}.root"
...
while (1)
  ...
  if ( $njob < 1 ) then 
    ...
    cd $OUTDIRSUB
    tcsh hadd_sim_h2_K0n_npi.csh
    tcsh hadd_simhist_h2_K0n.csh
    cd -
    break
  endif
