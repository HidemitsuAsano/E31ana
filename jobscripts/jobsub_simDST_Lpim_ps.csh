#!/bin/tcsh -f
set Version="1"
set DATADIR="/gpfs/group/had/knucl/e15/asano/sim/simLpim_ps${Version}/"
...
set OUTDIRSUB="${OUTDIR}simDSTLpim_ps${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 10)   
  ...
  set OUTFILE=${OUTDIRSUB}"/simDST_Lpim_ps_0${jobnum}.root"

  echo ${INPFILE}
  echo ${OUTFILE}

  set logname = "${logdir}/runLpim_ps$i.log"
