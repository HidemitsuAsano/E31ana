...
set Version="1"
set DSTVersion="1"
set DATADIR="/gpfs/group/had/knucl/e15/asano/sim/simLpim_ps${DSTVersion}/"
set CDSDIR="/gpfs/group/had/knucl/e15/asano/sim/simcds/"
set CDSDIRSUB="${CDSDIR}simDSTLpim_ps${DSTVersion}"
set OUTDIR="/gpfs/group/had/knucl/e15/asano/sim/simIMLPim_ps/"

set starttime=`date '+%y/%m/%d %H:%M:%S'`
set logbasedir="/home/had/hiasano/logs/"
set date=`date +%Y%m%d_%H%M`
set logdir="${logbasedir}${date}_simIMLpim_ps_${Version}"
...
while ($i < 10)   
  ...
  set INPFILE=${DATADIR}"sim_Lpim_ps_0${jobnum}.root"
  
  set CDSFILE=${CDSDIRSUB}"/simDST_Lpim_ps_0${jobnum}.root"
