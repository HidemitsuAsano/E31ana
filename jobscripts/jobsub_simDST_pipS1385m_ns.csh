#!/bin/tcsh -f
set Version="1"
set DATADIR="/gpfs/group/had/knucl/e15/asano/sim/simpipS1385m_ns${Version}/"
...
set OUTDIRSUB="${OUTDIR}simDSTpipS1385m_ns${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set OUTFILE=${OUTDIRSUB}"/simDST_pipS1385m_ns_0${jobnum}.root"

  echo ${INPFILE}
  echo ${OUTFILE}

  set lognamesp = "${logdir}/runpipS1385m_ns$i.log"
