...
set logdir="${logbasedir}${date}_IMLambda_${Version}"
...
set OUTDIRSUB="${OUTDIR}IMLambdav${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
else
...
cp $SRCDIR/EventAnalysisIMLambda.cpp $OUTDIRSUB/
...
ln -s $OUTDIRSUB/evanaIMLambdaPim_all.root post/evanaIMLambda_v${Version}.root
ln -s $OUTDIRSUB/evanaIMLambdaPim_all_ppimpim.root post/evanaIMLambda_ppimpim_v${Version}.root
