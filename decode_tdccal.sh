...
#do 
#echo $i 
#$ANAHOME/bin/evanatko conf/Run78/analyzer.conf $i tkoout/out$i\_2.root $HOME/Run78middata/tcal_00$i.dat
#done
...
do 
echo $i 
$ANAHOME/bin/evanatko conf/Run78/analyzer.conf $i tkoout/out$i\_3.root $HOME/Run78enddata/tcal_$i.dat
done
