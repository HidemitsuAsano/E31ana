...
void comp_fakedata_v4()
{
  ...
  TH1D* IMnpim_woSp_n_data = (TH1D*)IMnpim_woK0_woSp_n[0]->Clone("IMnpim_woSp_n_rdata");
  ...
  TH1D* IMnpip_woSm_n_data = (TH1D*)IMnpip_woK0_woSm_n[0]->Clone("IMnpip_woSm_n_rdata");
