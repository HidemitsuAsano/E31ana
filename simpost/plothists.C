...
void plothists(const char *filename="evanaIMpisigma_all_v22.root")
{
...
void QACDS(const char *filename){
  ...
  TCanvas *cCDHtimepy = new TCanvas("cCDHtimepy","CDHtimepy");
  cCDHtimepy->cd();
  TH1D* h2_CDHtime_py = h2_CDHtime->ProjectionY();
  h2_CDHtime_py->Draw();
...
void PhysicsPlots(const char *filename){
  ...
  //h2_IMnpim_IMnpip_dE_woK0->GetYaxis()->CenterTitle();
  ...
  TH2F* h2_IMnpim_IMnpip_wmn = f->Get("IMnpim_IMnpip_dE_woK0_n");
  ...
  TH2F* h2_IMmnpim_IMmnpip = f->Get("IMmnpim_IMmnpip_woK0_wSid_n");
  ...
  TH1F* h1_IMnpipi_woK0_wSid = f->Get("IMnpipi_woK0_wSid_n");
  ...
  h2_dE_MMom_fid_beta_woK0->GetXaxis()->CenterTitle();
  h2_dE_MMom_fid_beta_woK0->SetYTitle("Energy Dep. [MeVee]");
  h2_dE_MMom_fid_beta_woK0->GetYaxis()->CenterTitle();
  ...
  h2_dE_MMass_fid_beta_woK0->GetXaxis()->CenterTitle();
  h2_dE_MMass_fid_beta_woK0->SetYTitle("Energy Dep. [MeVee]");
  h2_dE_MMass_fid_beta_woK0->GetYaxis()->CenterTitle();
  ...
  TH2F* h2_MMnmiss_IMnpipi_woK0_wSid = f->Get("MMnmiss_IMnpipi_woK0_wSid_n");
  ...
  TH2F* h2_q_IMnpipi_woK0_wSid = f->Get("q_IMnpipi_woK0_wSid_n");
  ...
  h2_q_IMnpipi_woK0_wSid->RebinX(2);
  h2_q_IMnpipi_woK0_wSid->RebinY(6);
  ...
  //find 350 MeV/c bin
  int qcut350 = h2_q_IMnpipi_woK0_wSid->GetYaxis()->FindBin(0.350);  
  ...
  //h2_q_IMnpipi_woK0_wSid_px->SetMaximum(1700);
  h2_q_IMnpipi_woK0_wSid_px->Draw("E");

  TH1D* h2_q_IMnpipi_woK0_wSid_px_qcut350 = h2_q_IMnpipi_woK0_wSid->ProjectionX("pxcut",qcut350,300);
  h2_q_IMnpipi_woK0_wSid_px_qcut350->SetLineColor(2);
  h2_q_IMnpipi_woK0_wSid_px_qcut350->Draw("Esame");
  //h2_q_IMnpipi_woK0_wSid_px->SetTitle("");
  ...
  h2_q_IMnpipi_woK0_wSid_py->SetLineColor(2);
  h2_q_IMnpipi_woK0_wSid_py->Draw("Esame");
  ...
  h2_q_IMnpipi_woK0_wSid_py2->SetLineColor(3);
  h2_q_IMnpipi_woK0_wSid_py2->Draw("Esame");
