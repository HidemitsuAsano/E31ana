void combine_accmap(){
  ...
  TCanvas *cacc_Sp_nocut = new TCanvas("cacc_Sp_nocut","acc_Sp_nocut");
  ...
  TCanvas *cacc_Sp_cut1400 = new TCanvas("cacc_Sp_cut1400","acc_Sp_cut1400");
  ...
  TCanvas *cacc_Sp_add = new TCanvas("cacc_Sp_add","acc_Sp_add");
