#!/bin/tcsh -f
set Version="2"
set DATADIR="/gpfs/group/had/knucl/e15/asano/sim/simK0nn_Knts${Version}/"
...
set OUTDIRSUB="${OUTDIR}simDSTK0_Knts${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set OUTFILE=${OUTDIRSUB}"/simDST_K0nn_Knts_0${jobnum}.root"

  echo ${INPFILE}
  echo ${OUTFILE}

  set logname = "${logdir}/runK0_Knts$i.log"
