#!/bin/tcsh -f
set Version="1"
set DATADIR="/gpfs/group/had/knucl/e15/asano/sim/simpipiL_ns${Version}/"
...
set OUTDIRSUB="${OUTDIR}simDSTpipiL_ns${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set OUTFILE=${OUTDIRSUB}"/simDST_pipiL_ns_0${jobnum}.root"

  echo ${INPFILE}
  echo ${OUTFILE}

  set lognamesp = "${logdir}/runpipiL_ns$i.log"
