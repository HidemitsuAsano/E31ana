// MyAnalysisHeKpipipp.h

#ifndef MyAnalysisHeKpipipp_h
#define MyAnalysisHeKpipipp_h 1
...
class MyAnalysisHeKpipipp
{
  public:
    MyAnalysisHeKpipipp(TFile*,ConfMan*);
    ~MyAnalysisHeKpipipp();
  ...
  private:
    ...
    bool DoLambdaPosAna(Particle*,pBeam*,pCDS*,pCDS*,pCDS*,TVector3);
    bool DoLambdaNegAna(Particle*,pBeam*,pCDS*,pCDS*,pCDS*,TVector3);
    bool DoK0Ana(Particle*,pBeam*,pCDS*,pCDS*,TVector3);
