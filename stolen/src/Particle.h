...
class pBeam : public TObject
{
 ...
 public:
  ...
  void SetBHDX( const double &x ) { BHDX =x; }
	...
	void SetSIM( const bool &in ){ SIM=in; }
  ...
  void SetBLCDir(TVector3 &vec) { BLCDir = vec; BLCTRACK = true; }
	...
	void SetBeamChi2(const double &prob) { BeamChi2 = prob; }

	void SetBLC1Chi2(const double &prob) { BLC1Chi2 = prob; }
	void SetBLC2Chi2(const double &prob) { BLC2Chi2 = prob; }
	void SetBPCChi2(const double &prob) { BPCChi2 = prob; }
  
	void SetBLC1Prob(const double &prob) { BLC1Prob = prob; }
	void SetBLC2Prob(const double &prob) { BLC2Prob = prob; }
	void SetBPCProb(const double &prob) { BPCProb = prob; }
  ...
  TVector3 vertex() { return Vertex; }
	...
	double beamchi2() { return BeamChi2; }

	double blc1chi2() { return BLC1Chi2; }
	double blc2chi2() { return BLC2Chi2; }
	double bpcchi2() { return BPCChi2; }

	double blc1prob() { return BLC1Prob; }
	double blc2prob() { return BLC2Prob; }
	double bpcprob() { return BPCProb; }
...
class pPC : public pNC
{
  ...
  public:
    ...
    void CalcMom(pBeam* beam, const TVector3 &vertex,int pid=-1,bool tmp=false);
    void CalcMomBVC(const TVector3 &vertex,int pid=-1,bool tmp=false);
...
class pCDS : public TObject
{
  ...
  public:
    ...
    void SetBeta(const double &beta) { Beta= beta; }
    void SetdE(const double &de) { dE= de; }
    ...
    void SetProb(const double &prob) { Prob=prob; }
