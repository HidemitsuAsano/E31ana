...
#ifndef MyAnalysisHeK2CDS_h
#define MyAnalysisHeK2CDS_h 1
...
class MyAnalysisHeK2CDS
{
  public:
    MyAnalysisHeK2CDS(TFile*,ConfMan*);
    ~MyAnalysisHeK2CDS();
  ...
  private:
    ...
    bool DoLambdaAna(Particle*,pBeam*,pCDS*,TVector3);
    bool DoK0Ana(Particle*,pBeam*,pCDS*,TVector3);
