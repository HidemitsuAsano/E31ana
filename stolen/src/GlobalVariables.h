...
const int NumOfFDC1Layers=6;
const int NumOfBLC1Layers=8;
const int NumOfBLC2Layers=8;
...
const double cdsMass[10]={piMass,pMass,dMass,ThreeHeMass,ThreeHeMass,piMass,kpMass,0.0001,nMass,0.0001};
...
const int BHodoIDList[]={CID_BHD, CID_T0, CID_E0, CID_CVC, CID_NC,
			 CID_BVC, CID_PC, CID_LB, CID_WVC, CID_BPD,
			 CID_T0pre,CID_T0post,CID_BHDpost,CID_HVC1,CID_HVC2,
			 CID_BD,CID_TEMP1,CID_TEMP2,CID_START};
