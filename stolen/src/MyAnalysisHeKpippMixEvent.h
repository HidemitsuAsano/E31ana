// MyAnalysisHeKpippMixEvent.h

#ifndef MyAnalysisHeKpippMixEvent_h
#define MyAnalysisHeKpippMixEvent_h 1
...
class MyAnalysisHeKpippMixEvent
{
  public:
    MyAnalysisHeKpippMixEvent(TFile*,ConfMan*);
    ~MyAnalysisHeKpippMixEvent();
