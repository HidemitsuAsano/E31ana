// MyAnalysisBLDCCheckSource.h

#ifndef MyAnalysisBLDCCheckSource_h
#define MyAnalysisBLDCCheckSource_h 1
...
class MyAnalysisBLDCCheckSource
{
  public:
    MyAnalysisBLDCCheckSource(TFile*,ConfMan*);
    ~MyAnalysisBLDCCheckSource();
