...
bool MyAnalysisBL::DoAnalysis(ConfMan* conf, EventHeader* header, BeamLineHitMan* blMan, BeamLineTrackMan* bltrackMan, Particle* particle)
{
  ...
  //beam->SetBPCPos(trackblc2->GetPosatZ(0.0));
  //beam->SetBPCDir(dir);
