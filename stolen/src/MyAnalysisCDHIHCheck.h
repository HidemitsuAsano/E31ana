// MyAnalysisCDHIHCheck.h

#ifndef MyAnalysisCDHIHCheck_h
#define MyAnalysisCDHIHCheck_h 1
...
class MyAnalysisCDHIHCheck
{
  public:
    MyAnalysisCDHIHCheck(TFile*,ConfMan*);
    ~MyAnalysisCDHIHCheck();
