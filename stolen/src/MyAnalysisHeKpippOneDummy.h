// MyAnalysisHeKpippOneDummy.h

#ifndef MyAnalysisHeKpippOneDummy_h
#define MyAnalysisHeKpippOneDummy_h 1
...
class MyAnalysisHeKpippOneDummy
{
  public:
    MyAnalysisHeKpippOneDummy(TFile*,ConfMan*);
    ~MyAnalysisHeKpippOneDummy();
