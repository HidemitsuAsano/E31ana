// MyAnalysisCDCTrackingwSlew.h

#ifndef MyAnalysisCDCTrackingwSlew_h
#define MyAnalysisCDCTrackingwSlew_h 1
...
class MyAnalysisCDCTrackingwSlew
{
  public:
    MyAnalysisCDCTrackingwSlew(TFile*,ConfMan*);
    ~MyAnalysisCDCTrackingwSlew();
