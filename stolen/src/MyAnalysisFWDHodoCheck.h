// MyAnalysisFWDHodoCheck.h

#ifndef MyAnalysisFWDHodoCheck_h
#define MyAnalysisFWDHodoCheck_h 1
...
class MyAnalysisFWDHodoCheck
{
  public:
    MyAnalysisFWDHodoCheck(TFile*,ConfMan*);
    ~MyAnalysisFWDHodoCheck();
