// MyAnalysisCDSCheckCosmic.h

#ifndef MyAnalysisCDSCheckCosmic_h
#define MyAnalysisCDSCheckCosmic_h 1
...
class MyAnalysisCDSCheckCosmic
{
  public:
    MyAnalysisCDSCheckCosmic(TFile*,ConfMan*);
    ~MyAnalysisCDSCheckCosmic();
  ...
  public:
    bool DoAnalysis(ConfMan*,EventHeader*,BeamLineHitMan*,CDSHitMan*,CDSTrackingMan*);
    void Clear();
};
