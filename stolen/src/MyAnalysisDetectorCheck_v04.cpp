...
void MyAnalysisDetectorCheck::BLC1Check()
{
  ...
  FillHist("BLC1_TrackingEfficiency",0,1);
  FillHist("BLC1a_TrackingEfficiency",0,1);
  FillHist("BLC1b_TrackingEfficiency",0,1);

  /* BLC1 */
  int weight[4] = {1,1,1,1};
  FillHist("BLC1_NumberofTrack",bltrackMan->ntrackBLC1(),1);
  for(int i=0; i<bltrackMan->ntrackBLC1(); i++){
    ...
    FillHist("BLC1_TrackTime",tracktime,1);
    /* Tracking efficiency */
    FillHist("BLC1_TrackingEfficiency",1,weight[0]); /* No selection */
    weight[0]=0;
    if((-10<tracktime&&tracktime<10)){
      FillHist("BLC1_ChiSquare",chi2,1);
      FillHist("BLC1_TrackingEfficiency",2,weight[1]); /* Timing selection */
      weight[1]=0;
    }
    if((chi2<10)){
      FillHist("BLC1_TrackingEfficiency",3,weight[2]); /* chi2 selection */
      weight[2]=0;
    }
    if((-10<tracktime&&tracktime<10)&&(chi2<10)){
      FillHist("BLC1_TrackingEfficiency",4,weight[3]); /* Timing & chi2 selection */
      weight[3]=0;
    }
  }
  ...
  FillHist("BLC1a_NumberofTrack",bltrackMan->ntrackBLC1a(),1);
  for(int i=0; i<bltrackMan->ntrackBLC1a(); i++){
    ...
    FillHist("BLC1a_TrackTime",tracktime,1);
    /* Tracking efficiency */
    FillHist("BLC1a_TrackingEfficiency",1,weight[0]); /* No selection */
    weight[0]=0;
    if((-10<tracktime&&tracktime<10)){
      FillHist("BLC1a_ChiSquare",chi2,1);
      FillHist("BLC1a_TrackingEfficiency",2,weight[1]); /* Timing selection */
      weight[1]=0;
    }
    if((chi2<10)){
      FillHist("BLC1a_TrackingEfficiency",3,weight[2]); /* chi2 selection */
      weight[2]=0;
    }
    if((-10<tracktime&&tracktime<10)&&(chi2<10)){
      FillHist("BLC1a_TrackingEfficiency",4,weight[3]); /* Timing & chi2 selection */
      weight[3]=0;
      /* BLC1b Layer Hit Efficiencly */
      FillHist("BLC1b_HitEfficiency",0,1);
      for(int layer=1; layer<=8; layer++){
        if(blMan->nBLC1b(layer)>0){
          FillHist("BLC1b_HitEfficiency",layer,1);
        }
      }
    }
  }
  /* BLC1b */
  weight[0]=1;weight[1]=1;weight[2]=1;weight[3]=1;
  FillHist("BLC1b_NumberofTrack",bltrackMan->ntrackBLC1b(),1);
  for(int i=0; i<bltrackMan->ntrackBLC1b(); i++){
    ...
    FillHist("BLC1b_TrackTime",tracktime,1);
    /* Tracking efficiency */
    FillHist("BLC1b_TrackingEfficiency",1,weight[0]); /* No selection */
    weight[0]=0;
    if((-10<tracktime&&tracktime<10)){
      FillHist("BLC1b_ChiSquare",chi2,1);
      FillHist("BLC1b_TrackingEfficiency",2,weight[1]); /* Timing selection */
      weight[1]=0;
    }
    if((chi2<10)){
      FillHist("BLC1b_TrackingEfficiency",3,weight[2]); /* chi2 selection */
      weight[2]=0;
    }
    if((-10<tracktime&&tracktime<10)&&(chi2<10)){
      FillHist("BLC1b_TrackingEfficiency",4,weight[3]); /* Timing & chi2 selection */
      weight[3]=0;
      /* BLC1a Layer Hit Efficiencly */
      FillHist("BLC1a_HitEfficiency",0,1);
      for(int layer=1; layer<=8; layer++){
        if(blMan->nBLC1a(layer)>0){
          FillHist("BLC1a_HitEfficiency",layer,1);
        }
      }
    }
  }
...
void MyAnalysisDetectorCheck::BLC2Check()
{
  ...
  FillHist("BLC2_TrackingEfficiency",0,1);
  FillHist("BLC2a_TrackingEfficiency",0,1);
  FillHist("BLC2b_TrackingEfficiency",0,1);

  /* BLC2 */
  int weight[4] = {1,1,1,1};
  FillHist("BLC2_NumberofTrack",bltrackMan->ntrackBLC2(),1);
  for(int i=0; i<bltrackMan->ntrackBLC2(); i++){
    LocalTrack* blc2 = bltrackMan->trackBLC2(i);
    double tracktime = blc2->GetTrackTime();
    double chi2 = blc2->chi2all();
    FillHist("BLC2_TrackTime",tracktime,1);
    /* Tracking efficiency */
    FillHist("BLC2_TrackingEfficiency",1,weight[0]); /* No selection */
    weight[0]=0;
    if((-10<tracktime&&tracktime<10)){
      FillHist("BLC2_ChiSquare",chi2,1);
      FillHist("BLC2_TrackingEfficiency",2,weight[1]); /* Timing selection */
      weight[1]=0;
    }
    if((chi2<10)){
      FillHist("BLC2_TrackingEfficiency",3,weight[2]); /* chi2 selection */
      weight[2]=0;
    }
    if((-10<tracktime&&tracktime<10)&&(chi2<10)){
      FillHist("BLC2_TrackingEfficiency",4,weight[3]); /* Timing & chi2 selection */
      weight[3]=0;
    }
  }
  ...
  /* BLC2a */
  weight[0]=1;weight[1]=1;weight[2]=1;weight[3]=1;
  FillHist("BLC2a_NumberofTrack",bltrackMan->ntrackBLC2a(),1);
  for(int i=0; i<bltrackMan->ntrackBLC2a(); i++){
    ...
    FillHist("BLC2a_TrackTime",tracktime,1);
    /* Tracking efficiency */
    FillHist("BLC2a_TrackingEfficiency",1,weight[0]); /* No selection */
    weight[0]=0;
    if((-10<tracktime&&tracktime<10)){
      FillHist("BLC2a_ChiSquare",chi2,1);
      FillHist("BLC2a_TrackingEfficiency",2,weight[1]); /* Timing selection */
      weight[1]=0;
    }
    if((chi2<10)){
      FillHist("BLC2a_TrackingEfficiency",3,weight[2]); /* chi2 selection */
      weight[2]=0;
    }
    if((-10<tracktime&&tracktime<10)&&(chi2<10)){
      FillHist("BLC2a_TrackingEfficiency",4,weight[3]); /* Timing & chi2 selection */
      weight[3]=0;
      /* BLC2b Layer Hit Efficiencly */
      FillHist("BLC2b_HitEfficiency",0,1);
      for(int layer=1; layer<=8; layer++){
        if(blMan->nBLC2b(layer)>0){
          FillHist("BLC2b_HitEfficiency",layer,1);
        }
      }
    }
  }
  /* BLC2b */
  weight[0]=1;weight[1]=1;weight[2]=1;weight[3]=1;
  FillHist("BLC2b_NumberofTrack",bltrackMan->ntrackBLC2b(),1);
  for(int i=0; i<bltrackMan->ntrackBLC2b(); i++){
    ...
    FillHist("BLC2b_TrackTime",tracktime,1);
    /* Tracking efficiency */
    FillHist("BLC2b_TrackingEfficiency",1,weight[0]); /* No selection */
    weight[0]=0;
    if((-10<tracktime&&tracktime<10)){
      FillHist("BLC2b_ChiSquare",chi2,1);
      FillHist("BLC2b_TrackingEfficiency",2,weight[1]); /* Timing selection */
      weight[1]=0;
    }
    if((chi2<10)){
      FillHist("BLC2b_TrackingEfficiency",3,weight[2]); /* chi2 selection */
      weight[2]=0;
    }
    if((-10<tracktime&&tracktime<10)&&(chi2<10)){
      FillHist("BLC2b_TrackingEfficiency",4,weight[3]); /* Timing & chi2 selection */
      weight[3]=0;
      /* BLC2a Layer Hit Efficiencly */
      FillHist("BLC2a_HitEfficiency",0,1);
      for(int layer=1; layer<=8; layer++){
        if(blMan->nBLC2a(layer)>0){
          FillHist("BLC2a_HitEfficiency",layer,1);
        }
      }
    }
  }
...
void MyAnalysisDetectorCheck::BPCCheck()
{
  ...
  FillHist("BPC_TrackingEfficiency",0,1);

  /* BPC */
  int weight[4] = {1,1,1,1};
  FillHist("BPC_NumberofTrack",bltrackMan->ntrackBPC(),1);
  for(int i=0; i<bltrackMan->ntrackBPC(); i++){
    ...
    FillHist("BPC_TrackTime",tracktime,1);
    /* Tracking efficiency */
    FillHist("BPC_TrackingEfficiency",1,weight[0]); /* No selection */
    weight[0]=0;
    if((-10<tracktime&&tracktime<10)){
      FillHist("BPC_ChiSquare",chi2,1);
      FillHist("BPC_TrackingEfficiency",2,weight[1]); /* Timing selection */
      weight[1]=0;
    }
    if((chi2<10)){
      FillHist("BPC_TrackingEfficiency",3,weight[2]); /* chi2 selection */
      weight[2]=0;
    }
    if((-10<tracktime&&tracktime<10)&&(chi2<10)){
      FillHist("BPC_TrackingEfficiency",4,weight[3]); /* Timing & chi2 selection */
      weight[3]=0;
    }
  }
  /* Layer Hit Efficiency */
  FillHist("BPC_HitEfficiency",0,1);
  for(int layer=1; layer<=8; layer++){
    if(blMan->nBPC(layer)>0){
      FillHist("BPC_HitEfficiency",layer,1);
    }
  }
...
void MyAnalysisDetectorCheck::FDC1Check()
{
  ...
  FillHist("FDC1_TrackingEfficiency",0,1);

  /* FDC1 */
  int weight[4] = {1,1,1,1};
  FillHist("FDC1_NumberofTrack",bltrackMan->ntrackFDC1(),1);
  for(int i=0; i<bltrackMan->ntrackFDC1(); i++){
    ...
    FillHist("FDC1_TrackTime",tracktime,1);
    /* Tracking efficiency */
    FillHist("FDC1_TrackingEfficiency",1,weight[0]); /* No selection */
    weight[0]=0;
    if((-10<tracktime&&tracktime<10)){
      FillHist("FDC1_ChiSquare",chi2,1);
      FillHist("FDC1_TrackingEfficiency",2,weight[1]); /* Timing selection */
      weight[1]=0;
    }
    if((chi2<10)){
      FillHist("FDC1_TrackingEfficiency",3,weight[2]); /* chi2 selection */
      weight[2]=0;
    }
    if((-10<tracktime&&tracktime<10)&&(chi2<10)){
      FillHist("FDC1_TrackingEfficiency",4,weight[3]); /* Timing & chi2 selection */
      weight[3]=0;
    }
  }
  /* Layer Hit Efficiency */
  FillHist("FDC1_HitEfficiency",0,1);
  for(int layer=1; layer<=6; layer++){
    if(blMan->nFDC1(layer)>0){
      FillHist("FDC1_HitEfficiency",layer,1);
    }
  }
...
bool MyAnalysisDetectorCheck::Initialize(ConfMan* confMan)
{
  ...
  for(int idc=0;idc<2;idc++){
    ...
    const char* name= dlist->GetName(cid).data();
    const int nlays= dlist->GetNlayers(cid);
    new TH1F( Form("%s_TrackTime",name),Form("Track time %s;%s Track time (ns);Counts",name,name),1400,-200,500);
    new TH1F( Form("%s_ChiSquare",name),Form("#Chi^{2}/NDF %s;%s #Chi^{2}/NDF;Counts",name,name),200,0,100);
    new TH1F( Form("%s_NumberofTrack",name),Form("Number of tracks %s;%s Number of tracks;Counts",name,name),11,-0.5,10.5);
  ...
  for(int idc=2;idc<ndc;idc++){
    ...
    new TH1F( Form("%s_TrackTime",name),Form("Track time %s;%s Track time (ns);Counts",name,name),1400,-200,500);
    new TH1F( Form("%s_ChiSquare",name),Form("#Chi^{2}/NDF %s;%s #Chi^{2}/NDF;Counts",name,name),200,0,100);
    new TH1F( Form("%s_HitEfficiency",name),Form("Layer hit efficiency %s;%s Layer;Event",name,name),nlays+1,-0.5,nlays+0.5);
    new TH1F( Form("%s_NumberofTrack",name),Form("Number of tracks %s;%s Number of tracks;Counts",name,name),11,-0.5,10.5);
    new TH2F( Form("%s_TrackPosition",name),Form("Track position %s;%s X track position (cm);%s Y track position (cm)",name,name,name),400,-20,20,400,-20,20);
    new TH2F( Form("%s_TrackDirection",name),Form("Track position %s;%s X track direction;%s Y track direction",name,name,name),400,-0.02,0.02,400,-0.02,0.02);
    for(int layer=1; layer<=nlays; layer++){
      int nwires=dlist->GetNwires(cid);
      new TH1F( Form("%sl%d_Multiplicity",name,layer),Form("Multiplicity %s-L%d;%s-L%d Multiplicity;Counts",name,layer,name,layer),nwires+1,-0.5,nwires+0.5);
      new TH1F( Form("%sl%d_HitPattern",name,layer),Form("Hit pattern %s-L%d;%s-L%d Wire;Counts",name,layer,name,layer),nwires+1,-0.5,nwires+0.5);
      new TH1F( Form("%sl%d_Time",name,layer),Form("Time %s-L%d;%s-L%d Time (ns);Counts",name,layer,name,layer),500,-100,400);
      new TH1F( Form("%sl%d_Residual",name,layer),Form("Residual %s-L%d;%s-L%d Residual (ns);Counts",name,layer,name,layer),200,-0.2,0.2);
    }
  }
  new TH1F( Form("BLC1_TrackingEfficiency"),Form("Tracking efficiency BLC1;Layer;Event"),5,-0.5,4.5);
  new TH1F( Form("BLC2_TrackingEfficiency"),Form("Tracking efficiency BLC2;Layer;Event"),5,-0.5,4.5);
  new TH1F( Form("BPC_TrackingEfficiency"),Form("Tracking efficiency BPC;Layer;Event"),5,-0.5,4.5);
  new TH1F( Form("FDC1_TrackingEfficiency"),Form("Tracking efficiency FDC1;Layer;Event"),5,-0.5,4.5);
  new TH1F( Form("BPC_Number"),Form("Event Number BPC;;Event"),11,-0.5,10.5);
  return true;
}
