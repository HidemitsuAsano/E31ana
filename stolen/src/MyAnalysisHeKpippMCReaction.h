// MyAnalysisHeKpippMCReaction.h

#ifndef MyAnalysisHeKpippMCReaction_h
#define MyAnalysisHeKpippMCReaction_h 1
...
class MyAnalysisHeKpippMCReaction
{
  public:
    MyAnalysisHeKpippMCReaction(TFile*,ConfMan*);
    ~MyAnalysisHeKpippMCReaction();
