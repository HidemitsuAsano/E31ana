...
bool MyAnalysisK0::DoAnalysis(ConfMan* conf, EventHeader* header, BeamLineHitMan* blMan, BeamLineTrackMan* bltrackMan, CDSHitMan* cdsMan, CDSTrackingMan* cdstrackMan, Particle* _particle)
{
    ...
    for( int id2=id1+1; id2<particle->nCDS(); id2++ ){
      ...
      if(pro->comb()==pow(2,CDS_PiPlus)+pow(2,CDS_PiMinus)){
        ...
        if(cds1->pid()==CDS_PiMinus){
          ...
          pip_bg = Pp1.Mag()/cds1->pdgmass();
          pim_beta = L2.Beta();
          pip_beta = L1.Beta();
        }
        FillHist("pipi_Mass",cds_mass);
        FillHist("pipi_Momentum",cds_mom);
        FillHist("pipi_CosT",cds_cost);
        FillHist("pipi_FL",cds_fl);
        FillHist("pipi_VDIS",pro->vdis());
        FillHist("pipi_VBDIS",pro->vbdis());
        FillHist("pipi_PBDCA",pro->pbdca());
        FillHist("pipi_Massvspim_BetaGamma",pim_bg,cds_mass);
        FillHist("pipi_Massvspip_BetaGamma",pip_bg,cds_mass);
        FillHist("pipi_Massvspim_OverBeta2",1.0/pim_beta/pim_beta,cds_mass);
        FillHist("pipi_Massvspip_OverBeta2",1.0/pip_beta/pip_beta,cds_mass);
        FillHist("pim_Momentum",pim_mom);
        FillHist("pip_Momentum",pip_mom);
        /* For Lambda */
        if(k0ll<cds_mass&&cds_mass<k0ul){
          FillHist(Form("k0_Mass"),cds_mass);
          FillHist(Form("k0_Momentum"),cds_mom);
          FillHist(Form("k0_CosT"),cds_cost);
          FillHist("k0_FL",cds_fl);
          FillHist("k0_VDIS",pro->vdis());
          FillHist("k0_VBDIS",pro->vbdis());
          FillHist("k0_PBDCA",pro->pbdca());
          FillHist("k0_Massvspim_BetaGamma",pim_bg,cds_mass);
          FillHist("k0_Massvspip_BetaGamma",pip_bg,cds_mass);
          FillHist("k0_Massvspim_OverBeta2",1.0/pim_beta/pim_beta,cds_mass);
          FillHist("k0_Massvspip_OverBeta2",1.0/pip_beta/pip_beta,cds_mass);
          FillHist("pim_Momentum_k0",pim_mom);
          FillHist("pip_Momentum_k0",pip_mom);
        }
        if(sblk0ll<cds_mass&&cds_mass<sblk0ul){
          FillHist(Form("sblk0_Mass"),cds_mass);
          FillHist(Form("sblk0_Momentum"),cds_mom);
          FillHist(Form("sblk0_CosT"),cds_cost);
          FillHist("sblk0_FL",cds_fl);
          FillHist("sblk0_VDIS",pro->vdis());
          FillHist("sblk0_VBDIS",pro->vbdis());
          FillHist("sblk0_PBDCA",pro->pbdca());
          FillHist("sblk0_Massvspim_BetaGamma",pim_bg,cds_mass);
          FillHist("sblk0_Massvspip_BetaGamma",pip_bg,cds_mass);
          FillHist("sblk0_Massvspim_OverBeta2",1.0/pim_beta/pim_beta,cds_mass);
          FillHist("sblk0_Massvspip_OverBeta2",1.0/pip_beta/pip_beta,cds_mass);
          FillHist("pim_Momentum_sblk0",pim_mom);
          FillHist("pip_Momentum_sblk0",pip_mom);
        }
        if(sbuk0ll<cds_mass&&cds_mass<sbuk0ul){
          FillHist(Form("sbuk0_Mass"),cds_mass);
          FillHist(Form("sbuk0_Momentum"),cds_mom);
          FillHist(Form("sbuk0_CosT"),cds_cost);
          FillHist("sbuk0_FL",cds_fl);
          FillHist("sbuk0_VDIS",pro->vdis());
          FillHist("sbuk0_VBDIS",pro->vbdis());
          FillHist("sbuk0_PBDCA",pro->pbdca());
          FillHist("sbuk0_Massvspim_BetaGamma",pim_bg,cds_mass);
          FillHist("sbuk0_Massvspip_BetaGamma",pip_bg,cds_mass);
          FillHist("sbuk0_Massvspim_OverBeta2",1.0/pim_beta/pim_beta,cds_mass);
          FillHist("sbuk0_Massvspip_OverBeta2",1.0/pip_beta/pip_beta,cds_mass);
          FillHist("pim_Momentum_sbuk0",pim_mom);
          FillHist("pip_Momentum_sbuk0",pip_mom);
        }
      }
    }
  }
...
bool MyAnalysisK0::Initialize(ConfMan* confMan)
{
  ...
  TString pname[4]  = {"pipi","k0","sblk0","sbuk0"};
  TString pname2[4] = {"#pi^{+}#pi^{-}","K^{0}","K^{0}_{lower}","K^{0}_{upper}"};
  for(int ip=0; ip<4; ip++){
    new TH1F( Form("%s_Mass",pname[ip].Data()), Form("Invariant Mass (%s);IM(%s) (GeV/c^{2});Counts",pname2[ip].Data(),pname2[ip].Data()), 2000, 0.0, 1.0);
    ...
    new TH2F( Form("%s_Massvspim_BetaGamma",pname[ip].Data()), Form("Invariant Mass (%s) vs. #beta #gamma _{#pi^{-}} ;#beta #gamma _{#pi^{-}};IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data()), 400, 0.0, 4.0, 2000, 0.0, 1.0);
    new TH2F( Form("%s_Massvspip_BetaGamma",pname[ip].Data()), Form("Invariant Mass (%s) vs. #beta #gamma _{#pi^{+}} ;#beta #gamma _{#pi^{+}};IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data()), 400, 0.0, 4.0, 2000, 0.0, 1.0);

    new TH2F( Form("%s_Massvspim_OverBeta2",pname[ip].Data()), Form("Invariant Mass (%s) vs. 1/#beta^{2}_{#pi^{-}} ;1/#beta^{2}_{#pi^{-}};IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data()), 600, 0.0, 6.0, 2000, 0.0, 1.0);
    new TH2F( Form("%s_Massvspip_OverBeta2",pname[ip].Data()), Form("Invariant Mass (%s) vs. 1/#beta^{2}_{#pi^{+}} ;1/#beta^{2}_{#pi^{+}};IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data()), 600, 0.0, 6.0, 2000, 0.0, 1.0);
  }
  new TH1F( Form("pim_Momentum"), Form("Momentum (#pi^{-});Momentum (#pi^{-}) (GeV/c);Counts"), 2000, 0.0, 1.0);
  new TH1F( Form("pip_Momentum"), Form("Momentum (#pi^{+});Momentum (#pi^{+}) (GeV/c);Counts"), 2000, 0.0, 1.0);
  new TH1F( Form("pim_Momentum_k0"), Form("Momentum (#pi^{-});Momentum (#pi^{-}) (GeV/c);Counts"), 2000, 0.0, 1.0);
  new TH1F( Form("pip_Momentum_k0"), Form("Momentum (#pi^{+});Momentum (#pi^{+}) (GeV/c);Counts"), 2000, 0.0, 1.0);
  new TH1F( Form("pim_Momentum_sblk0"), Form("Momentum (#pi^{-});Momentum (#pi^{-}) (GeV/c);Counts"), 2000, 0.0, 1.0);
  new TH1F( Form("pip_Momentum_sblk0"), Form("Momentum (#pi^{+});Momentum (#pi^{+}) (GeV/c);Counts"), 2000, 0.0, 1.0);
  new TH1F( Form("pim_Momentum_sbuk0"), Form("Momentum (#pi^{-});Momentum (#pi^{-}) (GeV/c);Counts"), 2000, 0.0, 1.0);
  new TH1F( Form("pip_Momentum_sbuk0"), Form("Momentum (#pi^{+});Momentum (#pi^{+}) (GeV/c);Counts"), 2000, 0.0, 1.0);
