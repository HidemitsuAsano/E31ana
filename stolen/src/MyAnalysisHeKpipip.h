// MyAnalysisHeKpipip.h

#ifndef MyAnalysisHeKpipip_h
#define MyAnalysisHeKpipip_h 1
...
class MyAnalysisHeKpipip
{
  public:
    MyAnalysisHeKpipip(TFile*,ConfMan*);
    ~MyAnalysisHeKpipip();
  ...
  private:
    ...
    bool DoLambdaPosAna(Particle*,pBeam*,pCDS*,pCDS*,TVector3);
    bool DoLambdaNegAna(Particle*,pBeam*,pCDS*,pCDS*,TVector3);
