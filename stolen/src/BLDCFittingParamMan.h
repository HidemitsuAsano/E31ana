...
class BLDCFittingParamMan : public TObject
{
 ...
 public:
  std::string GetFileName() { return FileName; }
	void SetLayerDeadBLC1a(const int &i,bool s) { LayerDeadBLC1a[i]=s; }
	void SetLayerDeadBLC1b(const int &i,bool s) { LayerDeadBLC1b[i]=s; }
	void SetLayerDeadBLC2a(const int &i,bool s) { LayerDeadBLC2a[i]=s; }
	void SetLayerDeadBLC2b(const int &i,bool s) { LayerDeadBLC2b[i]=s; }
	void SetLayerDeadBPC(const int &i,bool s) { LayerDeadBPC[i]=s; }
	void SetLayerDeadFDC1(const int &i,bool s) { LayerDeadFDC1[i]=s; }
