...
#ifndef MyAnalysisdKnppim_h
#define MyAnalysisdKnppim_h 1
...
class MyAnalysisdKnppim
{
  public:
    MyAnalysisdKnppim(TFile*,ConfMan*);
    ~MyAnalysisdKnppim();
  ...
  private:
    ...
    double gamll, gamul;
    double sblgamll, sblgamul;
    double sbugamll, sbugamul;
    double p0ll, p0ul;
    double sblp0ll, sblp0ul;
    double sbup0ll, sbup0ul;
