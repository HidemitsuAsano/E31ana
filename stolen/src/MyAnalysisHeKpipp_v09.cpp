...
bool MyAnalysisHeKpipp::Initialize(ConfMan* confMan)
{
	...
	new TH1F("p_AngleKn_CM", "Angle between Kn plane and proton;cos#thetap;Counts", 3000, -1.5, 1.5);
	new TH2F("p_AngleKn_vs_pipp_MCosT_CM", "Angle between Kn plane and proton vs. cos#thetan;cos#thetap;cos#thetan", 300, -1.5, 1.5, 300, -1.5, 1.5);
	new TH2F("p_AngleKn_vs_pipp_Mass_CM", "Angle between Kn plane and proton vs. cos#thetan;cos#thetap;cos#thetan", 300, -1.5, 1.5, 500, 2.0, 3.0);
