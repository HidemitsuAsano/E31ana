// MyAnalysisCDSCosmic.h

#ifndef MyAnalysisCDSCosmic_h
#define MyAnalysisCDSCosmic_h 1
...
class MyAnalysisCDSCosmic
{
  public:
    MyAnalysisCDSCosmic(TFile*,ConfMan*);
    ~MyAnalysisCDSCosmic();
  ...
  public:
    bool DoAnalysis(ConfMan*,EventHeader*,CDSHitMan*,CDSTrackingMan*);
    void Clear();
};
