...
HistManBeamAna::HistManBeamAna(TFile *f, ConfMan *conf) : fFile(f)
{
  ...
  for( int seg1=1; seg1<=5; seg1++ ){
    ...
    new TH2F(Form("BHDT0%d_udE_k", seg1), Form("T0 seg%d up dE vs BHD-T0 TOF",seg1), 500, -0.5, 9.5, 500, 25, 35);
    new TH2F(Form("BHDT0%d_udE_pi", seg1), Form("T0 seg%d up dE vs BHD-T0 TOF",seg1), 500, -0.5, 9.5, 500, 25, 35);

    new TH2F(Form("BHDT0%d_ddE_k", seg1), Form("T0 seg%d down dE vs BHD-T0 TOF",seg1), 500, -0.5, 9.5, 500, 25, 35);
    new TH2F(Form("BHDT0%d_ddE_pi", seg1), Form("T0 seg%d down dE vs BHD-T0 TOF",seg1), 500, -0.5, 9.5, 500, 25, 35);

    new TH2F(Form("BHDT0%d_udE_corr_k", seg1), Form("T0 seg%d up dE vs BHD-T0 TOF",seg1), 500, -0.5, 9.5, 500, 25, 35);
    new TH2F(Form("BHDT0%d_udE_corr_pi", seg1), Form("T0 seg%d up dE vs BHD-T0 TOF",seg1), 500, -0.5, 9.5, 500, 25, 35);

    new TH2F(Form("BHDT0%d_ddE_corr_k", seg1), Form("T0 seg%d down dE vs BHD-T0 TOF",seg1), 500, -0.5, 9.5, 500, 25, 35);
    new TH2F(Form("BHDT0%d_ddE_corr_pi", seg1), Form("T0 seg%d down dE vs BHD-T0 TOF",seg1), 500, -0.5, 9.5, 500, 25, 35);
  ...
  for( int seg2=1; seg2<=20; seg2++ ){
    ...
    new TH2F(Form("BHD%d_udE_T0_k",seg2), Form("BHD seg%d up dE vs BHD-T0 TOF",seg2), 500, -0.5, 9.5, 500, 25, 35);
    new TH2F(Form("BHD%d_udE_T0_pi",seg2), Form("BHD seg%d up dE vs BHD-T0 TOF",seg2), 500, -0.5, 9.5, 500, 25, 35);

    new TH2F(Form("BHD%d_ddE_T0_k",seg2), Form("BHD seg%d down dE vs BHD-T0 TOF",seg2), 500, -0.5, 9.5, 500, 25, 35);
    new TH2F(Form("BHD%d_ddE_T0_pi",seg2), Form("BHD seg%d down dE vs BHD-T0 TOF",seg2), 500, -0.5, 9.5, 500, 25, 35);

    new TH2F(Form("BHD%d_udE_T0_corr_k",seg2), Form("BHD seg%d up dE vs BHD-T0 TOF",seg2), 500, -0.5, 9.5, 500, 25, 35);
    new TH2F(Form("BHD%d_udE_T0_corr_pi",seg2), Form("BHD seg%d up dE vs BHD-T0 TOF",seg2), 500, -0.5, 9.5, 500, 25, 35);

    new TH2F(Form("BHD%d_ddE_T0_corr_k",seg2), Form("BHD seg%d down dE vs BHD-T0 TOF",seg2), 500, -0.5, 9.5, 500, 25, 35);
    new TH2F(Form("BHD%d_ddE_T0_corr_pi",seg2), Form("BHD seg%d down dE vs BHD-T0 TOF",seg2), 500, -0.5, 9.5, 500, 25, 35);
  }
  ...
  if( fT0_hit.size()==1 ){
    if( fBHD_hit.size()==1 ){
      ...
      if( header->kaon(conf) ){
        ...
        h2 = getTH2(Form("BHDT0%d_udE_k", T0seg)), h2-> Fill(fT0_hit[0]->eu(), fT0_hit[0]->tu()-fBHD_hit[0]->ctmean());
        h2 = getTH2(Form("BHDT0%d_ddE_k", T0seg)), h2-> Fill(fT0_hit[0]->ed(), fT0_hit[0]->td()-fBHD_hit[0]->ctmean());
        h2 = getTH2(Form("BHDT0%d_udE_corr_k", T0seg)), h2-> Fill(fT0_hit[0]->eu(), tof);
        h2 = getTH2(Form("BHDT0%d_ddE_corr_k", T0seg)), h2-> Fill(fT0_hit[0]->ed(), tof);

        h2 = getTH2(Form("BHD%d_udE_T0_k", BHDseg)), h2-> Fill(fBHD_hit[0]->eu(), fT0_hit[0]->ctmean()-fBHD_hit[0]->tu());
        h2 = getTH2(Form("BHD%d_ddE_T0_k", BHDseg)), h2-> Fill(fBHD_hit[0]->ed(), fT0_hit[0]->ctmean()-fBHD_hit[0]->td());
        h2 = getTH2(Form("BHD%d_udE_T0_corr_k", BHDseg)), h2-> Fill(fBHD_hit[0]->eu(), tof);
        h2 = getTH2(Form("BHD%d_ddE_T0_corr_k", BHDseg)), h2-> Fill(fBHD_hit[0]->ed(), tof);
      }
      if( header->pion(conf) ){
        ...
        h2 = getTH2(Form("BHDT0%d_udE_pi", T0seg)), h2-> Fill(fT0_hit[0]->eu(), fT0_hit[0]->tu()-fBHD_hit[0]->ctmean());
        h2 = getTH2(Form("BHDT0%d_ddE_pi", T0seg)), h2-> Fill(fT0_hit[0]->ed(), fT0_hit[0]->td()-fBHD_hit[0]->ctmean());
        h2 = getTH2(Form("BHDT0%d_udE_corr_pi", T0seg)), h2-> Fill(fT0_hit[0]->eu(), tof);
        h2 = getTH2(Form("BHDT0%d_ddE_corr_pi", T0seg)), h2-> Fill(fT0_hit[0]->ed(), tof);

        h2 = getTH2(Form("BHD%d_udE_T0_pi", BHDseg)), h2-> Fill(fBHD_hit[0]->eu(), fT0_hit[0]->ctmean()-fBHD_hit[0]->tu());
        h2 = getTH2(Form("BHD%d_ddE_T0_pi", BHDseg)), h2-> Fill(fBHD_hit[0]->ed(), fT0_hit[0]->ctmean()-fBHD_hit[0]->td());
        h2 = getTH2(Form("BHD%d_udE_T0_corr_pi", BHDseg)), h2-> Fill(fBHD_hit[0]->eu(), tof);
        h2 = getTH2(Form("BHD%d_ddE_T0_corr_pi", BHDseg)), h2-> Fill(fBHD_hit[0]->ed(), tof);
      }
    }
