// MyAnalysisHeKpippfwd.h

#ifndef MyAnalysisHeKpippfwd_h
#define MyAnalysisHeKpippfwd_h 1
...
class MyAnalysisHeKpippfwd
{
  public:
    MyAnalysisHeKpippfwd(TFile*,ConfMan*);
    ~MyAnalysisHeKpippfwd();
