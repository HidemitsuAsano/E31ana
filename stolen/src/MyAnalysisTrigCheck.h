// MyAnalysisTrigCheck.h

#ifndef MyAnalysisTrigCheck_h
#define MyAnalysisTrigCheck_h 1
...
class MyAnalysisTrigCheck
{
  public:
    MyAnalysisTrigCheck(TFile*,ConfMan*);
    ~MyAnalysisTrigCheck();
  ...
  public:
    bool DoAnalysis(ConfMan*,EventHeader*,BeamLineHitMan*,CDSHitMan*);
    void Clear();
};
