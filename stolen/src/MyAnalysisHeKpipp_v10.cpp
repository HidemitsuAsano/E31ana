...
bool MyAnalysisHeKpipp::DoAnalysis(ConfMan* conf, EventHeader* header, BeamLineHitMan* blMan, BeamLineTrackMan* bltrackMan, CDSHitMan* cdsMan, CDSTrackingMan* cdstrackMan, Particle* particle)
{
  ...
  double cos_kn_p_lam = cos(kn_vect.Angle(p_vect));
	...
	double cos2eta = TMath::Cos(2*eta);
	double cos_kn_p_lam_sign = cos_kn_p_lam * TMath::Abs(cos2eta)/cos2eta;
  kn_vect = cLbeam.Vect().Cross(cLmn.Vect());
  p_vect = cLp.Vect();
  double cos_kn_p_nlam = cos(kn_vect.Angle(p_vect));
  ...
  FillHist(Form("p_AngleKnSign_LCM"),cos_kn_p_lam_sign);
  FillHist(Form("p_AngleKnSign_vs_pipp_MCosT_LCM"),cos_kn_p_lam_sign,pipp_mcost[1]);
  FillHist(Form("p_AngleKnSign_vs_pipp_Mass_LCM"),cos_kn_p_lam_sign,pipp_mass[1]);
  FillHist(Form("p_AngleKn_CM"),cos_kn_p_nlam);
  FillHist(Form("p_AngleKn_vs_pipp_MCosT_CM"),cos_kn_p_nlam,pipp_mcost[1]);
  FillHist(Form("p_AngleKn_vs_pipp_Mass_CM"),cos_kn_p_nlam,pipp_mass[1]);
...
bool MyAnalysisHeKpipp::Initialize(ConfMan* confMan)
{
	...
	new TH2F("pipp_IMvsHeKpipp_MCosT_2_CM", "(#pi^{-}p_{1}p_{2}) invariant mass vs. cos#theta_{n};IM(#pi^{-}p_{1}p_{2}) (GeV/c^{2});cos#theta_{n}", 200, 2.01, 4.01, 300, -1.5, 1.5);
	new TH2F("pipp_MMvsHeKpipp_MCosT_CM", "(#pi^{-}p_{1}p_{2}) missing mass vs. cos#theta_{n};MM(#pi^{-}p_{1}p_{2}) (GeV/c^{2});cos#theta_{n}", 200, 0.0, 2.0, 300, -1.5, 1.5);
	...
	new TH1F("p_AngleKnSign_LCM", "Angle between Kn plane and decayed proton;cos#thetap;Counts", 3000, -1.5, 1.5);
	new TH2F("p_AngleKnSign_vs_pipp_MCosT_LCM", "Angle between Kn plane and decayed proton vs. cos#thetan;cos#thetap;cos#thetan", 300, -1.5, 1.5, 300, -1.5, 1.5);
	new TH2F("p_AngleKnSign_vs_pipp_Mass_LCM", "Angle between Kn plane and decayed proton vs. cos#thetan;cos#thetap;cos#thetan", 300, -1.5, 1.5, 500, 2.0, 3.0);
	new TH1F("p_AngleKn_CM", "Angle between Kn plane and decayed proton;cos#thetap;Counts", 3000, -1.5, 1.5);
	new TH2F("p_AngleKn_vs_pipp_MCosT_CM", "Angle between Kn plane and decayed proton vs. cos#thetan;cos#thetap;cos#thetan", 300, -1.5, 1.5, 300, -1.5, 1.5);
	new TH2F("p_AngleKn_vs_pipp_Mass_CM", "Angle between Kn plane and decayed proton vs. cos#thetan;cos#thetap;IM(#Lambdap)", 300, -1.5, 1.5, 500, 2.0, 3.0);
