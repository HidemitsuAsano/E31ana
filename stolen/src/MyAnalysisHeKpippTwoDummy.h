// MyAnalysisHeKpippTwoDummy.h

#ifndef MyAnalysisHeKpippTwoDummy_h
#define MyAnalysisHeKpippTwoDummy_h 1
...
class MyAnalysisHeKpippTwoDummy
{
  public:
    MyAnalysisHeKpippTwoDummy(TFile*,ConfMan*);
    ~MyAnalysisHeKpippTwoDummy();
