...
class BeamLineHitMan : public HitMan
{
 ...
 private:
  ...
  HodoscopeLikeContainer DEFContainer;   
 ...
 public:
  ...
  // DEF
  int  nDEF() const { return DEFContainer.size(); }
  HodoscopeLikeHit *DEF( const int &i ) { return &DEFContainer[i]; }
  ...
  //// Start
  //int  nStart() const { return PAContainer.size(); }
  //HodoscopeLikeHit *Start( const int &i ) { return &PAContainer[i]; }

  //// Stop
  //int  nStop() const { return PAContainer.size(); }
  //HodoscopeLikeHit *Stop( const int &i ) { return &PAContainer[i]; }
