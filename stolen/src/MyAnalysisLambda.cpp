  ...
  for( int id1=0; id1<particle->nCDS(); id1++ ){
    for( int id2=id1+1; id2<particle->nCDS(); id2++ ){
      ...
      if(pro->comb()==pow(2,CDS_Proton)+pow(2,CDS_PiMinus)){
        ...
        double p_bg = 0.0;
        double p_beta = 0.0;
        double ppim_bg = cds_mom/cds_mass;
        ...
        FillHist("ppim_Phi",cds_phi);
        FillHist("ppim_FL",cds_fl);
        FillHist("ppim_VDIS",pro->vdis());
        FillHist("ppim_VBDIS",pro->vbdis());
        FillHist("ppim_PBDCA",pro->pbdca());
        FillHist("ppim_MassvsVertexX",vtx.X(),cds_mass);
        FillHist("ppim_MassvsVertexY",vtx.Y(),cds_mass);
        FillHist("ppim_MassvsVertexZ",vtx.Z(),cds_mass);
        FillHist("ppim_MassvsBVertexX",xest.X(),cds_mass);
        FillHist("ppim_MassvsBVertexY",xest.Y(),cds_mass);
        FillHist("ppim_MassvsBVertexZ",xest.Z(),cds_mass);
        FillHist("ppim_MassvsCosT",cds_cost,cds_mass);
        FillHist("ppim_MassvsPhi",cds_phi,cds_mass);
        FillHist("ppim_MassvsFL",cds_fl,cds_mass);
        FillHist("ppim_MassvsVDIS",pro->vdis(),cds_mass);
        FillHist("ppim_MassvsVBDIS",pro->vbdis(),cds_mass);
        FillHist("ppim_MassvsPBDCA",pro->pbdca(),cds_mass);
        FillHist("ppim_Massvspim_BetaGamma",pim_bg,cds_mass);
        FillHist("ppim_Massvsp_BetaGamma",p_bg,cds_mass);
        FillHist("ppim_Massvsppim_BetaGamma",ppim_bg,cds_mass);
        ...
        FillHist("pim_BetaGammavsp_BetaGamma",pim_bg,p_bg);
        /* For Lambda */
...
bool MyAnalysisLambda::Initialize(ConfMan* confMan)
{
  ...
  for(int ip=0; ip<1; ip++){
    ...
    new TH1F( Form("%s_Phi",pname[ip].Data()), Form("#phi (%s);#phi(%s);Counts",pname2[ip].Data(),pname2[ip].Data()), 350, -0.0, 3.5 );
    ...
    new TH2F( Form("%s_MassvsCosT",pname[ip].Data()), Form("Invariant Mass vs. cos#theta (%s);cos#theta (%s);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 300, -1.5, 1.5, 2000, 1.0, 2.0);
    new TH2F( Form("%s_MassvsPhi",pname[ip].Data()), Form("Invariant Mass vs. #phi (%s);#phi (%s);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 350, 0.0, 3.5, 2000, 1.0, 2.0);
    new TH2F( Form("%s_MassvsFL",pname[ip].Data()), Form("Invariant Mass vs. Flight length (%s);Flight length (%s) (cm);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 1000, 0.0, 30.0, 2000, 1.0, 2.0);
    new TH2F( Form("%s_MassvsVDIS",pname[ip].Data()), Form("Invariant Mass vs. VDIS (%s);VDIS (%s) (cm);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 1000, 0.0, 30.0, 2000, 1.0, 2.0);
    new TH2F( Form("%s_MassvsVBDIS",pname[ip].Data()), Form("Invariant Mass vs. VBDIS (%s);VBDIS (%s) (cm);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 1000, 0.0, 30.0, 2000, 1.0, 2.0);
    new TH2F( Form("%s_MassvsPBDCA",pname[ip].Data()), Form("Invariant Mass vs. PBDCA (%s);PBDCA (%s) (cm);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 1000, 0.0, 30.0, 2000, 1.0, 2.0);
    new TH2F( Form("%s_MassvsVertexX",pname[ip].Data()), Form("Invariant Mass vs. X position (%s);X position (%s) (cm);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 600, -30.0, 30.0, 2000, 1.0, 2.0);
    new TH2F( Form("%s_MassvsVertexY",pname[ip].Data()), Form("Invariant Mass vs. Y position (%s);Y position (%s) (cm);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 600, -30.0, 30.0, 2000, 1.0, 2.0);
    new TH2F( Form("%s_MassvsVertexZ",pname[ip].Data()), Form("Invariant Mass vs. Z position (%s);Z position (%s) (cm);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 1200, -30.0, 30.0, 2000, 1.0, 2.0);
    new TH2F( Form("%s_MassvsBVertexX",pname[ip].Data()), Form("Invariant Mass vs. X position (%s);X position (%s) (cm);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 600, -30.0, 30.0, 2000, 1.0, 2.0);
    new TH2F( Form("%s_MassvsBVertexY",pname[ip].Data()), Form("Invariant Mass vs. Y position (%s);Y position (%s) (cm);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 600, -30.0, 30.0, 2000, 1.0, 2.0);
    new TH2F( Form("%s_MassvsBVertexZ",pname[ip].Data()), Form("Invariant Mass vs. Z position (%s);Z position (%s) (cm);IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data(),pname2[ip].Data()), 1200, -30.0, 30.0, 2000, 1.0, 2.0);
    ...
    new TH2F( Form("%s_Massvsppim_BetaGamma",pname[ip].Data()), Form("Invariant Mass (%s) vs. #beta #gamma _{p#pi^{-}} ;#beta #gamma _{p#pi^{-}};IM(%s) (GeV/c^{2})",pname2[ip].Data(),pname2[ip].Data()), 200, 0.0, 2.0, 2000, 1.0, 2.0);
  ...
  new TH2F( "pim_BetaGammavsp_BetaGamma", "#beta #gamma _{#pi^{-}} vs. #beta #gamma _{p} ;#beta #gamma _{#pi^{-}};#beta #gamma _{p}", 200, 0.0, 2.0, 200, 0.0, 2.0);
