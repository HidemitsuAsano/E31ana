// MyAnalysisBLHodoCheck.h

#ifndef MyAnalysisBLHodoCheckStop_h
#define MyAnalysisBLHodoCheckStop_h 1
...
class MyAnalysisBLHodoCheck
{
  public:
    MyAnalysisBLHodoCheck(TFile*,ConfMan*);
    ~MyAnalysisBLHodoCheck();
