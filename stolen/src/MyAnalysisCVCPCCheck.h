// MyAnalysisCVCPCCheck.h

#ifndef MyAnalysisCVCPCCheck_h
#define MyAnalysisCVCPCCheck_h 1
...
class MyAnalysisCVCPCCheck
{
  public:
    MyAnalysisCVCPCCheck(TFile*,ConfMan*);
    ~MyAnalysisCVCPCCheck();
