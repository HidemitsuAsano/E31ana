// MyAnalysisCDCTrackEffic.h

#ifndef MyAnalysisCDCTrackEffic_h
#define MyAnalysisCDCTrackEffic_h 1
...
class MyAnalysisCDCTrackEffic
{
  public:
    MyAnalysisCDCTrackEffic(TFile*,ConfMan*);
    ~MyAnalysisCDCTrackEffic();
