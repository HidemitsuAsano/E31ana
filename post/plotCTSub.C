...
void plotCTSub()
{
  ...
  for(int irun=100;irun<800;irun++){
    char filename[1024];
    sprintf(filename,"/gpfs/group/had/knucl/e15/asano/Run78/IMpisigmav74/evanaIMpisigma_0%03d.root",irun);
    ...
    filenamecds.replace(filenamecds.size()-8,2,"34");
