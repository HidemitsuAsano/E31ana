...
void plothists(const char *filename="evanaIMpisigma_all_v8.root")
{
  ...
  TCanvas *cMMom_MMass_fid_beta_dE2_wSid = new TCanvas("cMMom_MMass_fid_beta_dE2_wSid","");
  TH2F* h2_MMom_MMass_fid_beta_dE2_wSid = f->Get("MMom_MMass_fid_beta_dE_woK0_wSid");
  h2_MMom_MMass_fid_beta_dE2_wSid->SetXTitle("missing mass [GeV/c^{2}]");
  h2_MMom_MMass_fid_beta_dE2_wSid->GetXaxis()->CenterTitle();
  h2_MMom_MMass_fid_beta_dE2_wSid->SetYTitle("missing momentum [GeV/c]");
  h2_MMom_MMass_fid_beta_dE2_wSid->GetYaxis()->CenterTitle();
  h2_MMom_MMass_fid_beta_dE2_wSid->Draw("colz");
  
  TCanvas *cMMom_MMass_fid_beta_dE2_wSid_px = new TCanvas("cMMom_MMass_fid_beta_dE2_px","");
  TH1D* proMMass2_wSid = h2_MMom_MMass_fid_beta_dE2_wSid->ProjectionX();
  proMMass2_wSid->Draw();
  ...
  TCanvas *cIMmnpim_IMmnpip_dE2 = new TCanvas("cIMmnpim_IMmnpip_dE2","");
  TH2F* h2_IMmnpim_IMmnpip_dE2 = f->Get("IMmnpim_IMmnpip_dE2");
  h2_IMmnpim_IMmnpip_dE2->SetXTitle("IM(#pi^{+}n) [GeV/c^{2}]");
  h2_IMmnpim_IMmnpip_dE2->GetXaxis()->CenterTitle();
  h2_IMmnpim_IMmnpip_dE2->SetYTitle("IM(#pi^{-}n) [GeV/c^{2}]");
  h2_IMmnpim_IMmnpip_dE2->GetYaxis()->CenterTitle();
  h2_IMmnpim_IMmnpip_dE2->Draw("colz");
  
  TCanvas *cIMmnpim_IMmnpip_dE2_px = new TCanvas("cIMmnpim_IMmnpip_dE2_px","");
  TH1D* h2_IMmnpim_IMmnpip_dE2_px = h2_IMmnpim_IMmnpip_dE2->ProjectionX();
  h2_IMmnpim_IMmnpip_dE2_px->Draw();
  //TH1D* h2_IMmnpim_IMmnpip_dE2_px_clone = h2_IMmnpim_IMmnpip_dE2_px->Clone();
  //h2_IMmnpim_IMmnpip_dE2_px_clone->GetXaxis()->SetRangeUser(anacuts::Sigmap_MIN,anacuts::Sigmap_MAX);
  //h2_IMmnpim_IMmnpip_dE2_px_clone->SetFillColor(3);
  //h2_IMmnpim_IMmnpip_dE2_px_clone->Draw("same");

  TCanvas *cIMmnpim_IMmnpip_dE2_py = new TCanvas("cIMmnpim_IMmnpip_dE2_py","");
  TH1D* h2_IMmnpim_IMmnpip_dE2_py = h2_IMmnpim_IMmnpip_dE2->ProjectionY();
  h2_IMmnpim_IMmnpip_dE2_py->Draw();
  //TH1D* h2_IMmnpim_IMmnpip_dE2_py_clone = h2_IMmnpim_IMmnpip_dE2_py->Clone();
  //h2_IMmnpim_IMmnpip_dE2_py_clone->GetXaxis()->SetRangeUser(anacuts::Sigmam_MIN,anacuts::Sigmam_MAX);
  //h2_IMmnpim_IMmnpip_dE2_py_clone->SetFillColor(4);
  //h2_IMmnpim_IMmnpip_dE2_py_clone->Draw("same");
