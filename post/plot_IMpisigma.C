...
void plot_IMpisigma(const char* filename="", const int qvalcutflag=0)
{
  ...
  if(MIXmode) std::cout << "real data mixed events " << std::endl;
  ...
  TF1 *fweight_MMnmiss_vSp21 = new TF1("fweight_MMnmiss_vSp21",func_MMnmiss_mod,0,1.5,20);
  fweight_MMnmiss_vSp21->SetParameters(param_MMnmiss_mod);

  TF1* fweight_IMpippim_vSp22 = new TF1("fweight_IMpippim_vSp22",func_IMpippim_mod,0.,1.0,15);
  fweight_IMpippim_vSp22->SetParameters(param_IMpippim_mod);
  
  TF1* fweight_nmom_vSp23 = new TF1("fweight_nmom_vSp23",func_nmom_mod,0.139,1.0,12);
  fweight_nmom_vSp23->SetParameters(param_nmom_mod);
  ...
  TF1* fweight_Mompippim_vSp26 = new TF1("fweight_Mompippim_vSp26",func_Mompippim,0,1.5,7);
  fweight_Mompippim_vSp26->SetParameters(param_Mompippim);
 
  TF1* fweight_Momnpip_vSp27 = new TF1("fweight_Momnpip_vSp27",func_Momnpip,0,1.5,6);
  fweight_Momnpip_vSp27->SetParameters(param_Momnpip);
  
  TF1* fweight_Momnpim_vSp28 = new TF1("fweight_Momnpim_vSp28",func_Momnpim,0,1.5,8);
  fweight_Momnpim_vSp28->SetParameters(param_Momnpim);
 
  TFile *fweight_vSp1 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv1.root","READ");
  TH1D* fweight_MMnmiss_vSp1 = (TH1D*)fweight_vSp1->Get("MMnmiss_woK0_woSid_won_ratio");

  TFile *fweight_vSp2 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv2.root","READ");
  TH1D* fweight_IMnpip_vSp2 = (TH1D*)fweight_vSp2->Get("IMnpip_woK0_woSid_won_ratio");

  TFile *fweight_vSp3 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv3.root","READ");
  TH1D* fweight_IMnpim_vSp3 = (TH1D*)fweight_vSp3->Get("IMnpim_woK0_woSid_won_ratio");

  TFile *fweight_vSp4 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv4.root","READ");
  TH1D* fweight_IMpippim_vSp4 = (TH1D*)fweight_vSp4->Get("IMpippim_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp5 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv5.root","READ");
  TH2D* fweight_nmom_vSp5 = (TH2D*)fweight_vSp5->Get("nmom_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp6 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv6.root","READ");
  TH2D* fweight_Momnpip_vSp6 = (TH2D*)fweight_vSp6->Get("Momnpip_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp7 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv7.root","READ");
  TH2D* fweight_Momnpim_vSp7 = (TH2D*)fweight_vSp7->Get("Momnpim_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp8 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv8.root","READ");
  TH2D* fweight_Mompippim_vSp8 = (TH2D*)fweight_vSp8->Get("Mompippim_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp9 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv9.root","READ");
  TH1D* fweight_MMnmiss_vSp9 = (TH1D*)fweight_vSp9->Get("MMnmiss_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp10 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv10.root","READ");
  TH1D* fweight_IMnpip_vSp10 = (TH1D*)fweight_vSp10->Get("IMnpip_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp11 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv11.root","READ");
  TH1D* fweight_IMnpim_vSp11 = (TH1D*)fweight_vSp11->Get("IMnpim_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp12 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv12.root","READ");
  TH1D* fweight_IMpippim_vSp12 = (TH1D*)fweight_vSp12->Get("IMpippim_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp13 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv13.root","READ");
  TH2D* fweight_nmom_vSp13 = (TH2D*)fweight_vSp13->Get("nmom_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp14 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv14.root","READ");
  TH2D* fweight_Momnpip_vSp14 = (TH2D*)fweight_vSp14->Get("Momnpip_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp15 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv15.root","READ");
  TH2D* fweight_Mompippim_vSp15 = (TH2D*)fweight_vSp15->Get("Mompippim_woK0_woSid_won_ratio");

  TFile *fweight_vSp16 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv16.root","READ");
  TH1D* fweight_MMnmiss_vSp16 = (TH1D*)fweight_vSp16->Get("MMnmiss_woK0_woSid_won_ratio");

  TFile *fweight_vSp17 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv17.root","READ");
  TH2D* fweight_Mompippim_vSp17 = (TH2D*)fweight_vSp17->Get("Mompippim_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp18 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv18.root","READ");
  TH1D* fweight_IMpippim_vSp18 = (TH1D*)fweight_vSp18->Get("IMpippim_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp19 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv19.root","READ");
  TH1D* fweight_IMnpip_vSp19 = (TH1D*)fweight_vSp19->Get("IMnpip_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp20 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv20.root","READ");
  TH1D* fweight_IMnpim_vSp20 = (TH1D*)fweight_vSp20->Get("IMnpim_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp21 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv21.root","READ");
  TH2D* fweight_Momnpip_vSp21 = (TH2D*)fweight_vSp21->Get("Momnpip_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp22 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv22.root","READ");
  TH1D* fweight_MMnmiss_vSp22 = (TH1D*)fweight_vSp22->Get("MMnmiss_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp23 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv23.root","READ");
  TH1D* fweight_IMpippim_vSp23 = (TH1D*)fweight_vSp23->Get("IMpippim_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp24 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv24.root","READ");
  TH2D* fweight_Mompippim_vSp24 = (TH2D*)fweight_vSp24->Get("Mompippim_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp25 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv25.root","READ");
  TH2D* fweight_Momnpim_vSp25 = (TH2D*)fweight_vSp25->Get("Momnpim_woK0_woSid_won_ratio");
  
  TFile *fweight_vSp26 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv26.root","READ");
  TH1D* fweight_MMnmiss_vSp26 = (TH1D*)fweight_vSp26->Get("MMnmiss_woK0_woSid_won_ratio");

  TFile *fweight_vSp27 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv27.root","READ");
  TH1D* fweight_IMpippim_vSp27 = (TH1D*)fweight_vSp27->Get("IMpippim_woK0_woSid_won_ratio");

  TFile *fweight_vSp28 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv28.root","READ");
  TH2D* fweight_Mompippim_vSp28 = (TH2D*)fweight_vSp28->Get("Mompippim_woK0_woSid_won_ratio");

  TFile *fweight_vSp29 = new TFile("../simpost/compgeantSp/comp_fakedata_out_vv29.root","READ");
  TH1D* fweight_IMnpip_vSp29 = (TH1D*)fweight_vSp29->Get("IMnpip_woK0_woSid_won_ratio");
  
  const char kinval[][10] = {"MMnmiss","IMnpip","IMnpim","IMpippim","nmom","Momnpip","Momnpim","Mompippim"};
  ...
  TH2F* MMnmiss_IMpippim_dE_wSid_n_fake_pat2;//for GEANT4 sim.
  TH2F* MMnmiss_IMpippim_dE_wSid_n_fake_pat7;//for GEANT4 sim.
  ...
  MMnmiss_react = new TH1F("MMnmiss_react","MMnmiss_react",1000,0,1.5);
  ...
  IMnpim_MMnpim_mc = new TH2F("IMnpim_MMnpim_mc","IMnpim_MMnpim_mc",280,1.,1.7,280,1.0,1.7);
  IMnpim_MMnpim_mc->SetYTitle("true  IM(n_{CDS}#pi^{-}) [GeV/c^{2}]");
  IMnpim_MMnpim_mc->SetXTitle("true  IM(n_{miss}#pi^{-}) [GeV/c^{2}]");
  
  IMnpim_MMnpim_mc_wSid_n_fake = new TH2F("IMnpim_MMnpim_mc_wSid_n_fake","IMnpim_MMnpim_mc_wSid_n_fake",280,1.,1.7,280,1.0,1.7);
  ...
  IMnpim_MMnpim_mc_wSid_n_fake_pat2 = new TH2F("IMnpim_MMnpim_mc_wSid_n_fake_pat2","IMnpim_MMnpim_mc_wSid_n_fake_pat2",280,1.,1.7,280,1.0,1.7);
  ...
  IMnpim_MMnpim_mc_wSid_n_fake_pat7 = new TH2F("IMnpim_MMnpim_mc_wSid_n_fake_pat7","IMnpim_MMnpim_mc_wSid_n_fake_pat7",280,1.,1.7,280,1.0,1.7);
  ...
  IMnpim_MMnpim_mc_vtx = new TH2F("IMnpim_MMnpim_mc_vtx","IMnpim_MMnpim_mc_vtx",280,1.,1.7,280,1.0,1.7);
  IMnpim_MMnpim_mc_vtx->SetYTitle("true  IM(n_{CDS}#pi^{-})  [GeV/c^{2}]");
  IMnpim_MMnpim_mc_vtx->SetXTitle("true  IM(n_{miss}#pi^{-}) [GeV/c^{2}]");
  
  IMnpim_MMnpim_mc_vtx_pat2 = new TH2F("IMnpim_MMnpim_mc_vtx_pat2","IMnpim_MMnpim_mc_vtx_pat2",280,1.,1.7,280,1.0,1.7);
  ...
  IMnpim_MMnpim_mc_vtx_pat7 = new TH2F("IMnpim_MMnpim_mc_vtx_pat7","IMnpim_MMnpim_mc_vtx_pat7",280,1.,1.7,280,1.0,1.7);
  ...
  IMnpip_MMnpip_mc = new TH2F("IMnpip_MMnpip_mc","IMnpip_MMnpip_mc",280,1,1.7,280,1.0,1.7);
  IMnpip_MMnpip_mc->SetYTitle("true IM(n_{CDS}#pi^{+}) [GeV/c^{2}]");
  IMnpip_MMnpip_mc->SetXTitle("true IM(n_{miss}#pi^{+}) [GeV/c^{2}]");
  
  IMnpip_MMnpip_mc_wSid_n_fake = new TH2F("IMnpip_MMnpip_mc_wSid_n_fake","IMnpip_MMnpip_mc_wSid_n_fake",280,1,1.7,280,1.0,1.7);
  ...
  IMnpip_MMnpip_mc_wSid_n_fake_pat2 = new TH2F("IMnpip_MMnpip_mc_wSid_n_fake_pat2","IMnpip_MMnpip_mc_wSid_n_fake_pat2",280,1,1.7,280,1.0,1.7);
  ...
  IMnpip_MMnpip_mc_wSid_n_fake_pat7 = new TH2F("IMnpip_MMnpip_mc_wSid_n_fake_pat7","IMnpip_MMnpip_mc_wSid_n_fake_pat7",280,1,1.7,280,1.0,1.7);
  ...
  IMnpip_MMnpip_mc_vtx = new TH2F("IMnpip_MMnpip_mc_vtx","IMnpip_MMnpip_mc_vtx",280,1,1.7,280,1.,1.7);
  IMnpip_MMnpip_mc_vtx->SetYTitle("true IM(n_{CDS}#pi^{+}) [GeV/c^{2}]");
  IMnpip_MMnpip_mc_vtx->SetXTitle("true IM(n_{miss}#pi^{+} ) [GeV/c^{2}]");
  
  IMnpip_MMnpip_mc_vtx_pat2 = new TH2F("IMnpip_MMnpip_mc_vtx_pat2","IMnpip_MMnpip_mc_vtx_pat2",280,1,1.7,280,1.,1.7);
  ...
  IMnpip_MMnpip_mc_vtx_pat7 = new TH2F("IMnpip_MMnpip_mc_vtx_pat7","IMnpip_MMnpip_mc_vtx_pat7",280,1,1.7,280,1.,1.7);
  ...
  diff2D_MMnmiss_IMnpim_recomc_woK0_wSid_n_fake1 = new TH2F("diff2D_MMnmiss_IMnpim_recomc_woK0_wSid_n_fake1","diff2D_MMnmiss_IMnpim_recomc_woK0_wSid_n_fake1",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_MMnmiss_IMnpip_recomc_woK0_wSid_n = new TH2F("diff2D_MMnmiss_IMnpip_recomc_woK0_wSid_n","diff2D_MMnmiss_IMnpip_recomc_woK0_wSid_n",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_MMnmiss_IMnpip_recomc_woK0_wSid_n_fake1 = new TH2F("diff2D_MMnmiss_IMnpip_recomc_woK0_wSid_n_fake1","diff2D_MMnmiss_IMnpip_recomc_woK0_wSid_n_fake1",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_MMnmiss_IMnpim_recomc_wK0_wSid_n = new TH2F("diff2D_MMnmiss_IMnpim_recomc_wK0_wSid_n","diff2D_MMnmiss_IMnpim_recomc_wK0_wSid_n",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_MMnmiss_IMnpim_recomc_wK0_wSid_n_fake1 = new TH2F("diff2D_MMnmiss_IMnpim_recomc_wK0_wSid_n_fake1","diff2D_MMnmiss_IMnpim_recomc_wK0_wSid_n_fake1",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_MMnmiss_IMnpip_recomc_wK0_wSid_n = new TH2F("diff2D_MMnmiss_IMnpip_recomc_wK0_wSid_n","diff2D_MMnmiss_IMnpip_recomc_wK0_wSid_n",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_MMnmiss_IMnpip_recomc_wK0_wSid_n_fake1 = new TH2F("diff2D_MMnmiss_IMnpip_recomc_wK0_wSid_n_fake1","diff2D_MMnmiss_IMnpip_recomc_wK0_wSid_n_fake1",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_MMnmiss_IMnpim_recomc_wSid_n = new TH2F("diff2D_MMnmiss_IMnpim_recomc_wSid_n","diff2D_MMnmiss_IMnpim_recomc_wSid_n",2000,-1.0,1.0,3000,-1.5,1.5);
  ...
  diff2D_MMnmiss_IMnpim_recomc_wSid_n_fake1 = new TH2F("diff2D_MMnmiss_IMnpim_recomc_wSid_n_fake1","diff2D_MMnmiss_IMnpim_recomc_wSid_n_fake1",2000,-1.0,1.0,3000,-1.5,1.5);
  ...
  diff2D_MMnmiss_IMnpip_recomc_wSid_n = new TH2F("diff2D_MMnmiss_IMnpip_recomc_wSid_n","diff2D_MMnmiss_IMnpip_recomc_wSid_n",2000,-1.0,1.0,3000,-1.5,1.5);
  ...
  diff2D_MMnmiss_IMnpip_recomc_wSid_n_fake1 = new TH2F("diff2D_MMnmiss_IMnpip_recomc_wSid_n_fake1","diff2D_MMnmiss_IMnpip_recomc_wSid_n_fake1",2000,-1.0,1.0,3000,-1.5,1.5);
  ...
  diff2D_nmom_IMnpim_recomc_woK0_wSid_n = new TH2F("diff2D_nmom_IMnpim_recomc_woK0_wSid_n","diff2D_nmom_IMnpim_recomc_woK0_wSid_n",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_nmom_IMnpim_recomc_woK0_wSid_n_fake1 = new TH2F("diff2D_nmom_IMnpim_recomc_woK0_wSid_n_fake1","diff2D_nmom_IMnpim_recomc_woK0_wSid_n_fake1",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_nmom_IMnpip_recomc_woK0_wSid_n = new TH2F("diff2D_nmom_IMnpip_recomc_woK0_wSid_n","diff2D_nmom_IMnpip_recomc_woK0_wSid_n",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_nmom_IMnpip_recomc_woK0_wSid_n_fake1 = new TH2F("diff2D_nmom_IMnpip_recomc_woK0_wSid_n_fake1","diff2D_nmom_IMnpip_recomc_woK0_wSid_n_fake1",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_nmom_IMnpim_recomc_wK0_wSid_n = new TH2F("diff2D_nmom_IMnpim_recomc_wK0_wSid_n","diff2D_nmom_IMnpim_recomc_wK0_wSid_n",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_nmom_IMnpim_recomc_wK0_wSid_n_fake1 = new TH2F("diff2D_nmom_IMnpim_recomc_wK0_wSid_n_fake1","diff2D_nmom_IMnpim_recomc_wK0_wSid_n_fake1",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_nmom_IMnpip_recomc_wK0_wSid_n = new TH2F("diff2D_nmom_IMnpip_recomc_wK0_wSid_n","diff2D_nmom_IMnpip_recomc_wK0_wSid_n",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_nmom_IMnpip_recomc_wK0_wSid_n_fake1 = new TH2F("diff2D_nmom_IMnpip_recomc_wK0_wSid_n_fake1","diff2D_nmom_IMnpip_recomc_wK0_wSid_n_fake1",200,-1.0,1.0,300,-1.5,1.5);
  ...
  diff2D_nmom_IMnpim_recomc_wSid_n = new TH2F("diff2D_nmom_IMnpim_recomc_wSid_n","diff2D_nmom_IMnpim_recomc_wSid_n",2000,-1.0,1.0,3000,-1.5,1.5);
  ...
  diff2D_nmom_IMnpip_recomc_wSid_n = new TH2F("diff2D_nmom_IMnpip_recomc_wSid_n","diff2D_nmom_IMnpip_recomc_wSid_n",2000,-1.0,1.0,3000,-1.5,1.5);
  ...
  vtxr_vtxz_mc = new TH2F("vtxr_vtxz_mc","vtxr_vtxz_mc",750,-75,75,480,0,120.0);
  vtxr_vtxz_mc->SetXTitle("n_{CDS} origin in Z [cm] ");
  vtxr_vtxz_mc->SetYTitle("n_{CDS} origin in R [cm] ");

  vtxr_vtxz_mc_pat2 = new TH2F("vtxr_vtxz_mc_pat2","vtxr_vtxz_mc_pat2",750,-75,75,480,0,120.0);
  vtxr_vtxz_mc_pat2->SetXTitle("n_{CDS} origin in Z [cm] ");
  vtxr_vtxz_mc_pat2->SetYTitle("n_{CDS} origin in R [cm] ");
  
  vtxr_vtxz_mc_pat7 = new TH2F("vtxr_vtxz_mc_pat7","vtxr_vtxz_mc_pat7",750,-75,75,480,0,120.0);
  vtxr_vtxz_mc_pat7->SetXTitle("n_{CDS} origin in Z [cm] ");
  vtxr_vtxz_mc_pat7->SetYTitle("n_{CDS} origin in R [cm] ");

  vtxr_vtxz_ncan_wSid_n_mc = new TH2F("vtxr_vtxz_ncan_wSid_n_mc","vtxr_vtxz_ncan_wSid_n_mc",750,-75,75,480,0,120.0);
  vtxr_vtxz_ncan_wSid_n_mc->SetXTitle("n_{CDS} origin in Z [cm] ");
  vtxr_vtxz_ncan_wSid_n_mc->SetYTitle("n_{CDS} origin in R [cm] ");
  
  vtxr_vtxz_ncan_wSid_n_mc_pat2 = new TH2F("vtxr_vtxz_ncan_wSid_n_mc_pat2","vtxr_vtxz_ncan_wSid_n_mc_pat2",750,-75,75,480,0,120.0);
  ...
  vtxr_vtxz_ncan_wSid_n_mc_pat7 = new TH2F("vtxr_vtxz_ncan_wSid_n_mc_pat7","vtxr_vtxz_ncan_wSid_n_mc_pat7",750,-75,75,480,0,120.0);
  ...
  MMnmiss_IMpippim_dE = new TH2F("MMnmiss_IMpippim_dE", "MMnmiss_IMpippim_dE",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMpippim_dE->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMpippim_dE->SetYTitle("Miss Mass. [GeV/c^{2}]");
  
  MMnmiss_IMpippim_dE_viciSp = new TH2F("MMnmiss_IMpippim_dE_viciSp", "MMnmiss_IMpippim_dE_viciSp",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMpippim_dE_viciSp->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMpippim_dE_viciSp->SetYTitle("Miss Mass. [GeV/c^{2}]");
 
  MMnmiss_IMpippim_dE_viciSm = new TH2F("MMnmiss_IMpippim_dE_viciSm", "MMnmiss_IMpippim_dE_viciSm",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMpippim_dE_viciSm->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMpippim_dE_viciSm->SetYTitle("Miss Mass. [GeV/c^{2}]");

  MMnmiss_IMpippim_dE_wSid = new TH2F("MMnmiss_IMpippim_dE_wSid", "MMnmiss_IMpippim_dE_wSid",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  ...
  MMnmiss_IMpippim_dE_wSid_n_fake = new TH2F("MMnmiss_IMpippim_dE_wSid_n_fake", "MMnmiss_IMpippim_dE_wSid_n_fake",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMpippim_dE_wSid_n_fake->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMpippim_dE_wSid_n_fake->SetYTitle("Miss Mass. [GeV/c^{2}]");
  
  MMnmiss_IMpippim_dE_wSid_n_fake_pat2 = new TH2F("MMnmiss_IMpippim_dE_wSid_n_fake_pat2", "MMnmiss_IMpippim_dE_wSid_n_fake_pat2",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMpippim_dE_wSid_n_fake_pat2->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMpippim_dE_wSid_n_fake_pat2->SetYTitle("Miss Mass. [GeV/c^{2}]");
  
  MMnmiss_IMpippim_dE_wSid_n_fake_pat7 = new TH2F("MMnmiss_IMpippim_dE_wSid_n_fake_pat7", "MMnmiss_IMpippim_dE_wSid_n_fake_pat7",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMpippim_dE_wSid_n_fake_pat7->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMpippim_dE_wSid_n_fake_pat7->SetYTitle("Miss Mass. [GeV/c^{2}]");



  MMnmiss_IMpippim_dE_woK0 = new TH2F("MMnmiss_IMpippim_dE_woK0", "MMnmiss_IMpippim_dE_woK0",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMpippim_dE_woK0->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMpippim_dE_woK0->SetYTitle("Miss Mass. [GeV/c^{2}]");

  MMnmiss_IMpippim_dE_woK0_wSid = new TH2F("MMnmiss_IMpippim_dE_woK0_wSid", "MMnmiss_IMpippim_dE_woK0_wSid",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMpippim_dE_woK0_wSid->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMpippim_dE_woK0_wSid->SetYTitle("Miss Mass. [GeV/c^{2}]");
  
  MMnmiss_IMpippim_dE_woK0_wSid_n = new TH2F("MMnmiss_IMpippim_dE_woK0_wSid_n", "MMnmiss_IMpippim_dE_woK0_wSid_n",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMpippim_dE_woK0_wSid_n->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMpippim_dE_woK0_wSid_n->SetYTitle("Miss Mass. [GeV/c^{2}]");
  
  MMnmiss_IMpippim_dE_wK0_wSid = new TH2F("MMnmiss_IMpippim_dE_wK0_wSid", "MMnmiss_IMpippim_dE_wK0_wSid",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMpippim_dE_wK0_wSid->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMpippim_dE_wK0_wSid->SetYTitle("Miss Mass. [GeV/c^{2}]");
  
  MMnmiss_IMpippim_dE_wK0_wSid_n = new TH2F("MMnmiss_IMpippim_dE_wK0_wSid_n", "MMnmiss_IMpippim_dE_wK0_wSid_n",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  ...
  MMnmiss_IMpippim_dE_woK0_woSid = new TH2F("MMnmiss_IMpippim_dE_woK0_woSid", "MMnmiss_IMpippim_dE_woK0_woSid",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  ...
  MMnmiss_IMpippim_dE_woK0_woSid_won = new TH2F("MMnmiss_IMpippim_dE_woK0_woSid_won", "MMnmiss_IMpippim_dE_woK0_woSid_won",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  ...
  MMnmiss_IMpippim_dE_wK0_woSid_won = new TH2F("MMnmiss_IMpippim_dE_wK0_woSid_won", "MMnmiss_IMpippim_dE_wK0_woSid_won",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  ...
  MMnmiss_IMpippim_dE_wK0_woSidn_won = new TH2F("MMnmiss_IMpippim_dE_wK0_woSidn_won", "MMnmiss_IMpippim_dE_wK0_woSidn_won",nbinpippim,0.,1.0,nbinnmiss, nmisslow, nmisshigh);
  ...
  MMnmiss_IMpippim_dE_woK0_woSidn = new TH2F("MMnmiss_IMpippim_dE_woK0_woSidn", "MMnmiss_IMpippim_dE_woK0_woSidn",nbinpippim,0,1,nbinnmiss, nmisslow, nmisshigh);
  ...
  IMnpim_IMnpip_dE_wK0_n = new TH2F("IMnpim_IMnpip_dE_wK0_n","IMnpim_IMnpip_dE_wK0_n",nbinIMnpi, 1, 2.0, nbinIMnpi, 1, 2.0);
  ...
  pipmom_pimmom_dE_woK0_woSid_won = new TH2F("pipmom_pimmom_dE_woK0_woSid_won","pipmom_pimmom_dE_woK0_woSid_won",200,0,1.0,200,0,1.0);
  ...
  MMnmiss_IMnpipi_wSid = new TH2F(Form("MMnmiss_IMnpipi_wSid"),Form("MMnmiss_IMnpipi_wSid"),nbinIMnpipi,1,2,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMnpipi_wSid->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMnpipi_wSid->SetYTitle("Miss. Mass. [GeV/c^{2}]");

  MMnmiss_IMnpipi_wK0_wSid = new TH2F("MMnmiss_IMnpipi_wK0_wSid","MMnmiss_IMnpipi_wK0_wSid",nbinIMnpipi,1,2,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMnpipi_wK0_wSid->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMnpipi_wK0_wSid->SetYTitle("Miss. Mass. [GeV/c^{2}]");
  
  MMnmiss_IMnpipi_woK0_wSid = new TH2F(Form("MMnmiss_IMnpipi_woK0_wSid"),Form("MMnmiss_IMnpipi_woK0_wSid"),nbinIMnpipi,1,2,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMnpipi_woK0_wSid->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMnpipi_woK0_wSid->SetYTitle("Miss. Mass. [GeV/c^{2}]");

  MMnmiss_IMnpipi_woK0_wSid_Sp = new TH2F("MMnmiss_IMnpipi_woK0_wSid_Sp","MMnmiss_IMnpipi_woK0_wSid_Sp",nbinIMnpipi,1,2,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMnpipi_woK0_wSid_Sp->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMnpipi_woK0_wSid_Sp->SetYTitle("Miss. Mass. [GeV/c^{2}]");

  MMnmiss_IMnpipi_woK0_wSid_Sm = new TH2F("MMnmiss_IMnpipi_woK0_wSid_Sm","MMnmiss_IMnpipi_woK0_wSid_Sm",nbinIMnpipi,1,2,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMnpipi_woK0_wSid_Sm->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMnpipi_woK0_wSid_Sm->SetYTitle("Miss. Mass. [GeV/c^{2}]");

  MMnmiss_IMnpipi_wK0_woSid_won = new TH2F("MMnmiss_IMnpipi_wK0_woSid_won","MMnmiss_IMnpipi_wK0_woSid_won",nbinIMnpipi,1,2,nbinnmiss, nmisslow, nmisshigh);
  ...
  MMnmiss_IMnpipi_wK0_woSidn_won = new TH2F("MMnmiss_IMnpipi_wK0_woSidn_won","MMnmiss_IMnpipi_wK0_woSidn_won",nbinIMnpipi,1,2,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMnpipi_wK0_woSidn_won->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMnpipi_wK0_woSidn_won->SetYTitle("Miss. Mass. [GeV/c^{2}]");

  MMnmiss_IMnpipi_woK0_woSidn = new TH2F("MMnmiss_IMnpipi_woK0_woSidn","MMnmiss_IMnpipi_woK0_woSidn",nbinIMnpipi,1,2,nbinnmiss, nmisslow, nmisshigh);
  MMnmiss_IMnpipi_woK0_woSidn->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMnpipi_woK0_woSidn->SetYTitle("Miss. Mass. [GeV/c^{2}]");

  MMnmiss_IMnpipi_woK0_woSid_won = new TH2F("MMnmiss_IMnpipi_woK0_woSid_won","MMnmiss_IMnpipi_woK0_woSid_won",nbinIMnpipi,1,2,nbinnmiss, nmisslow, nmisshigh);
  ...
  for(int ithcut=0;ithcut<nthetacut;ithcut++){
    ...
    q_IMnpipi_wSid_n_thetacut[ithcut] = new TH2F(Form("q_IMnpipi_wSid_n_thetacut%d",ithcut),Form("q_IMnpipi_wSid_n #theta_{CM} below %d^{#circ}",cuttheta),
                                                nbinIMnpipi,1,2,nbinq,0,1.5); 
  ...
  q_IMnpipi_wSid_n_fake = new TH2F("q_IMnpipi_wSid_n_fake","q_IMnpipi_wSid_n_fake",nbinIMnpipi,1,2,nbinq,0,1.5);
  q_IMnpipi_wSid_n_fake->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  q_IMnpipi_wSid_n_fake->SetYTitle("Mom. Transfer [GeV/c]");
  
  q_IMnpipi_wSid_n_fake_pat2 = new TH2F("q_IMnpipi_wSid_n_fake_pat2","q_IMnpipi_wSid_n_fake_pat2",nbinIMnpipi,1,2,nbinq,0,1.5);
  q_IMnpipi_wSid_n_fake_pat2->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  q_IMnpipi_wSid_n_fake_pat2->SetYTitle("Mom. Transfer [GeV/c]");
  
  q_IMnpipi_wSid_n_fake_pat7 = new TH2F("q_IMnpipi_wSid_n_fake_pat7","q_IMnpipi_wSid_n_fake_pat7",nbinIMnpipi,1,2,nbinq,0,1.5);
  q_IMnpipi_wSid_n_fake_pat7->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  q_IMnpipi_wSid_n_fake_pat7->SetYTitle("Mom. Transfer [GeV/c]");
  
  q_IMnpipi_wSid_n_wocross = new TH2F("q_IMnpipi_wSid_n_wocross","q_IMnpipi_wSid_n_wocross",nbinIMnpipi,1,2,nbinq,0,1.5);
  ...
  q_IMnpipi_wSid_n_Sp_woSm = new TH2F("q_IMnpipi_wSid_n_Sp_woSm","q_IMnpipi_wSid_n_Sp_woSm", nbinIMnpipi,1,2, nbinq,0,1.5);
  ...
  nmom_IMnpipi_wK0_n = new TH2F("nmom_IMnpipi_wK0_n","nmom_IMnpipi_wK0_n", nbinIMnpipi,1,2,nbinnmom,0,1.0);
  nmom_IMnpipi_wK0_n->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  nmom_IMnpipi_wK0_n->SetYTitle("nmom  [GeV/c]");

  nmom_IMnpipi_wK0_wSid_n = new TH2F(Form("nmom_IMnpipi_wK0_wSid_n"),Form("nmom_IMnpipi_wK0_wSid_n"), nbinIMnpipi,1,2,nbinnmom,0,1.0);
  nmom_IMnpipi_wK0_wSid_n->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  nmom_IMnpipi_wK0_wSid_n->SetYTitle("nmom  [GeV/c]");
  
  nmom_IMnpipi_wK0_woSid_won = new TH2F("nmom_IMnpipi_wK0_woSid_won","nmom_IMnpipi_wK0_woSid_won", nbinIMnpipi,1,2,nbinnmom,0,1.0);
  nmom_IMnpipi_wK0_woSid_won->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  nmom_IMnpipi_wK0_woSid_won->SetYTitle("nmom  [GeV/c]");

  nmom_IMnpipi_wK0_woSid_n = new TH2F("nmom_IMnpipi_wK0_woSid_n","nmom_IMnpipi_wK0_woSid_n", nbinIMnpipi,1,2,nbinnmom,0,1.0);
  ...
  nmom_IMnpipi_wSid_n = new TH2F(Form("nmom_IMnpipi_wSid_n"),Form("nmom_IMnpipi_wSid_n"), nbinIMnpipi,1,2,nbinnmom,0,1.0);
  nmom_IMnpipi_wSid_n->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  nmom_IMnpipi_wSid_n->SetYTitle("nmom  [GeV/c]");

  nmom_IMnpipi_woK0_wSid_n = new TH2F(Form("nmom_IMnpipi_woK0_wSid_n"),Form("nmom_IMnpipi_woK0_wSid_n"), nbinIMnpipi,1,2,nbinnmom,0,1.0);
  nmom_IMnpipi_woK0_wSid_n->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  nmom_IMnpipi_woK0_wSid_n->SetYTitle("nmom  [GeV/c]");
  
  nmom_IMnpipi_woK0_woSid_won = new TH2F(Form("nmom_IMnpipi_woK0_woSid_won"),Form("nmom_IMnpipi_woK0_woSid_won"), nbinIMnpipi,1,2,nbinnmom,0,1.0);
  nmom_IMnpipi_woK0_woSid_won->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  nmom_IMnpipi_woK0_woSid_won->SetYTitle("nmom  [GeV/c]");

  nmom_IMnpipi_woK0_wSid_n_Sp = new TH2F(Form("nmom_IMnpipi_woK0_wSid_n_Sp"),Form("nmom_IMnpipi_woK0_wSid_n_Sp"), nbinIMnpipi,1,2,nbinnmom,0,1.0);
  nmom_IMnpipi_woK0_wSid_n_Sp->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  nmom_IMnpipi_woK0_wSid_n_Sp->SetYTitle("nmom  [GeV/c]");

  nmom_IMnpipi_woK0_wSid_n_Sm = new TH2F(Form("nmom_IMnpipi_woK0_wSid_n_Sm"),Form("nmom_IMnpipi_woK0_wSid_n_Sm"), nbinIMnpipi,1,2,nbinnmom,0,1.0);
  ...
  nmom_IMpippim = new TH2F(Form("nmom_IMpippim"),Form("nmom_IMpippim"), nbinpippim,0,1,nbinnmom,0,1.0);
  ...
  nmom_IMpippim_n = new TH2F(Form("nmom_IMpippim_n"),Form("nmom_IMpippim_n"), nbinpippim,0,1,nbinnmom,0,1.0);
  nmom_IMpippim_n->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  nmom_IMpippim_n->SetYTitle("nmom  [GeV/c]");

  nmom_IMpippim_wSid_n = new TH2F("nmom_IMpippim_wSid_n","nmom_IMpippim_wSid_n", nbinpippim,0,1,nbinnmom,0,1.0);
  nmom_IMpippim_wSid_n->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  nmom_IMpippim_wSid_n->SetYTitle("nmom  [GeV/c]");
  
  nmom_IMpippim_woK0_woSid_won = new TH2F("nmom_IMpippim_woK0_woSid_won","nmom_IMpippim_woK0_woSid_won", nbinpippim,0,1,nbinnmom,0,1.0);
  nmom_IMpippim_woK0_woSid_won->SetXTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  nmom_IMpippim_woK0_woSid_won->SetYTitle("nmom  [GeV/c]");
  
  nmom_IMpippim_wK0_woSid_won = new TH2F("nmom_IMpippim_wK0_woSid_won","nmom_IMpippim_wK0_woSid_won", nbinpippim,0,1,nbinnmom,0,1.0);
  ...
  q_IMpippim_wSid_n = new TH2F("q_IMpippim_wSid_n","q_IMpippim_wSid_n",nbinpippim,0,1, 100,0,1.5);
  ...
  IMpippim_IMnpip_vici_woSm = new TH2F("IMpippim_IMnpip_vici_woSm","IMpippim_IMnpip_vici_woSm",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpip_n_woSm = new TH2F("IMpippim_IMnpip_n_woSm","IMpippim_IMnpip_n_woSm",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpip_n_woSmdia = new TH2F("IMpippim_IMnpip_n_woSmdia","IMpippim_IMnpip_n_woSmdia",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpip_wSid_n_Sp = new TH2F("IMpippim_IMnpip_wSid_n_Sp","IMpippim_IMnpip_wSid_n_Sp",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  for(unsigned int ibin=0;ibin<nbintemplate;ibin++){
    float binlow=1.0+(float)ibin*1./nbintemplate;
    float binhigh=1.0+(float)(ibin+1.0)*1./nbintemplate;
    IMpippim_IMnpip_wSid_n_Sp_bin[ibin] = new TH2F(Form("IMpippim_IMnpip_wSid_n_Sp_bin%d",ibin),Form("IMpippim_IMnpip_wSid_n_Sp %0.2f-%0.2f",binlow,binhigh)
        ,nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpip_wSid_n_woSm = new TH2F("IMpippim_IMnpip_wSid_n_woSm","IMpippim_IMnpip_wSid_n_woSm",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpip_wK0_n = new TH2F("IMpippim_IMnpip_wK0_n","IMpippim_IMnpip_wK0_n",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  for(unsigned int ibin=0;ibin<nbintemplate;ibin++){
    float binlow=1.0+(float)ibin*1./nbintemplate;
    float binhigh=1.0+(float)(ibin+1.0)*1./nbintemplate;
    IMpippim_IMnpip_wK0_n_bin[ibin] = new TH2F(Form("IMpippim_IMnpip_wK0_n_bin%d",ibin),Form("IMpippim_IMnpip_wK0_n %0.2f-%0.2f",binlow,binhigh)
        ,nbinIMnpi,1,2,nbinpippim,0,1);
    IMpippim_IMnpip_wK0_n_bin[ibin]->SetXTitle("IM(n#pi^{+}) [GeV/c^{2}]");
    IMpippim_IMnpip_wK0_n_bin[ibin]->SetYTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  }
  
  IMpippim_IMnpip_wK0_n_woSmdia = new TH2F("IMpippim_IMnpip_wK0_n_woSmdia","IMpippim_IMnpip_wK0_n_woSmdia",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpip_wK0orwSid_n = new TH2F("IMpippim_IMnpip_wK0orwSid_n","IMpippim_IMnpip_wK0orwSid_n",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpip_wK0orwSid_n_woSmdia = new TH2F("IMpippim_IMnpip_wK0orwSid_n_woSmdia","IMpippim_IMnpip_wK0orwSid_n_woSmdia",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpim_vici = new TH2F("IMpippim_IMnpim_vici","IMpippim_IMnpim_vici",nbinIMnpi,1,2,nbinpippim,0,1);
  IMpippim_IMnpim_vici->SetXTitle("IM(n#pi^{-}) [GeV/c^{2}]");
  IMpippim_IMnpim_vici->SetYTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");
  
  IMpippim_IMnpim_vici_woSp = new TH2F("IMpippim_IMnpim_vici_woSp","IMpippim_IMnpim_vici_woSp",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpim_n_woSp = new TH2F("IMpippim_IMnpim_n_woSp","IMpippim_IMnpim_n_woSp",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpim_n_woSpdia = new TH2F("IMpippim_IMnpim_n_woSpdia","IMpippim_IMnpim_n_woSpdia",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpim_wSid_n_Sm = new TH2F("IMpippim_IMnpim_wSid_n_Sm","IMpippim_IMnpim_wSid_n_Sm",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpim_wSid_n_woSp = new TH2F("IMpippim_IMnpim_wSid_n_woSp","IMpippim_IMnpim_wSid_n_woSp",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpim_wK0_n = new TH2F("IMpippim_IMnpim_wK0_n","IMpippim_IMnpim_wK0_n",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpim_wK0_n_woSpdia = new TH2F("IMpippim_IMnpim_wK0_n_woSpdia","IMpippim_IMnpim_wK0_n_woSpdia",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpim_wK0orwSid_n = new TH2F("IMpippim_IMnpim_wK0orwSid_n","IMpippim_IMnpim_wK0orwSid_n",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpim_wK0orwSid_n_woSpdia = new TH2F("IMpippim_IMnpim_wK0orwSid_n_woSpdia","IMpippim_IMnpim_wK0orwSid_n_woSpdia",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  IMpippim_IMnpip_woK0_woSid_won = new TH2F("IMpippim_IMnpip_woK0_woSid_won","IMpippim_IMnpip_woK0_woSid_won",nbinIMnpi,1,2,nbinpippim,0,1);
  IMpippim_IMnpip_woK0_woSid_won->SetXTitle("IM(n#pi^{+}) [GeV/c^{2}]");
  IMpippim_IMnpip_woK0_woSid_won->SetYTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");

  IMpippim_IMnpim_woK0_woSid_won = new TH2F("IMpippim_IMnpim_woK0_woSid_won","IMpippim_IMnpim_woK0_woSid_won",nbinIMnpi,1,2,nbinpippim,0,1);
  IMpippim_IMnpim_woK0_woSid_won->SetXTitle("IM(n#pi^{-}) [GeV/c^{2}]");
  IMpippim_IMnpim_woK0_woSid_won->SetYTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");

  IMpippim_IMnpip_wK0_woSid_won = new TH2F("IMpippim_IMnpip_wK0_woSid_won","IMpippim_IMnpip_wK0_woSid_won",nbinIMnpi,1,2,nbinpippim,0,1);
  IMpippim_IMnpip_wK0_woSid_won->SetXTitle("IM(n#pi^{+}) [GeV/c^{2}]");
  IMpippim_IMnpip_wK0_woSid_won->SetYTitle("IM(#pi^{+}#pi^{-}) [GeV/c^{2}]");

  IMpippim_IMnpim_wK0_woSid_won = new TH2F("IMpippim_IMnpim_wK0_woSid_won","IMpippim_IMnpim_wK0_woSid_won",nbinIMnpi,1,2,nbinpippim,0,1);
  ...
  for ( Int_t i=0; i<nevent; i++ ) {
    ...
    double cos_nmiss = LVec_npipimiss_CM.Vect().Dot(LVec_beam_CM.Vect())/(LVec_npipimiss_CM.Vect().Mag()*LVec_beam_CM.Vect().Mag());
    ...
    if(NBetaOK && NdEOK) {
      ...
      if(K0Flag) {
        ...
        nmissmom_cosnmiss_wK0->Fill(cos_nmiss,LVec_npipimiss.P(),weight);
    ...
    if(NBetaOK && NdEOK && MissNFlag) {
      ...
      if(!SigmawidePFlag  && !SigmawideMFlag){
        ...
        if(K0rejectFlag){
          //MMnpim_MMnpip_woK0_woSid_n->Fill(LVec_pip_nmiss.M(),LVec_pim_nmiss.M());
    ...
    if(K0Flag && NBetaOK && NdEOK && MissNFlag) {
      ...
      nmissmom_cosnmiss_wK0_n->Fill(cos_nmiss,LVec_npipimiss.P(),weight);
      ...
      IMpippim_IMnpim_wK0_n_bin[binnum]->Fill(LVec_pim_n.M(),LVec_pip_pim.M(),weight);
