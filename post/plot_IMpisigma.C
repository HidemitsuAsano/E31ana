...
void plot_IMpisigma(const char* filename="",const int qvalcutflag=0)
{
  ...
  std::cout << std::endl;
  std::cout << "nuetron momentum cut below:  " << anacuts::nmomcut  << std::endl;
  std::cout << std::endl;
  ...
  MMom_MMass_woK0_wSid = new TH2F(Form("MMom_MMass_woK0_wSid"),Form("MMom_MMass_woK0_wSid"), 100, 0.4, 1.9, 100, 0, 1.5);
  ...
  MMnmiss_IMnpipi_wSid = new TH2F(Form("MMnmiss_IMnpipi_wSid"),Form("MMnmiss_IMnpipi_wSid"),nbinIMnpipi,1,2,100,0.4,1.9);
  MMnmiss_IMnpipi_wSid->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMnpipi_wSid->SetYTitle("Miss. Mass. [GeV/c^{2}]");
  
  MMnmiss_IMnpipi_woK0_wSid = new TH2F(Form("MMnmiss_IMnpipi_woK0_wSid"),Form("MMnmiss_IMnpipi_woK0_wSid"),nbinIMnpipi,1,2,100,0.4,1.9);
  MMnmiss_IMnpipi_woK0_wSid->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMnpipi_woK0_wSid->SetYTitle("Miss. Mass. [GeV/c^{2}]");
  
  MMnmiss_IMnpipi_woK0_wSid_Sp = new TH2F(Form("MMnmiss_IMnpipi_woK0_wSid_Sp"),Form("MMnmiss_IMnpipi_woK0_wSid_Sp"),nbinIMnpipi,1,2,100,0.4,1.9);
  MMnmiss_IMnpipi_woK0_wSid_Sp->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  MMnmiss_IMnpipi_woK0_wSid_Sp->SetYTitle("Miss. Mass. [GeV/c^{2}]");
  
  MMnmiss_IMnpipi_woK0_wSid_Sm = new TH2F(Form("MMnmiss_IMnpipi_woK0_wSid_Sm"),Form("MMnmiss_IMnpipi_woK0_wSid_Sm"),nbinIMnpipi,1,2,100,0.4,1.9);
  ...
  nmom_MMnmiss_wK0_woSid = new TH2F(Form("nmom_MMnmiss_wK0_woSid"),Form("nmom_MMnmiss_wK0_woSid"), 100,0.4,1.9,100,0,1.0);
  ...
  nmom_cosn_wSid_n->SetXTitle("nCDS mom [GeV/c]");
  nmom_cosn_wSid_n->SetYTitle("nCDS cos#theta_cm");
  
  nmom_cosn_woK0_wSid_n = new TH2F("nmom_cosn_woK0_wSid_n","nmom_cosn_woK0_wSid_n",100,-1.0,1.0,100,0,1.0);
  nmom_cosn_woK0_wSid_n->SetXTitle("nCDS mom [GeV/c]");
  nmom_cosn_woK0_wSid_n->SetYTitle("nCDS cos#theta_cm");
  ...
  pimmom_diffz_CDC_CDH_pim = new TH2F("pimmom_diffz_CDC_CDH_pim","pimmom_diffz_CDC_CDH_pim",100,-1.*TMath::Pi(),TMath::Pi(), 200,0,1);
  pimmom_diffz_CDC_CDH_pim->SetXTitle("CDH hit - #pi^{-} track (z) [cm]");
  pimmom_diffz_CDC_CDH_pim->SetYTitle("#pi^{-} mom. [GeV/c]");

  pipmom_diffz_CDC_CDH_pip = new TH2F("pipmom_diffz_CDC_CDH_pip","pipmom_diffz_CDC_CDH_pip",100,-1.*TMath::Pi(),TMath::Pi(), 200,0,1);
  ...
  nmom_diffz_CDC_CDH_pim = new TH2F("nmom_diffz_CDC_CDH_pim","nmom_diffz_CDC_CDH_pim",100,-1.*TMath::Pi(),TMath::Pi(),100,0,1);
  nmom_diffz_CDC_CDH_pim->SetXTitle("CDH hit - #pi^{-} track (z) [cm]");
  nmom_diffz_CDC_CDH_pim->SetYTitle("nmom.  [GeV/c]");
  
  nmom_diffz_CDC_CDH_pip = new TH2F("nmom_diffz_CDC_CDH_pip","nmom_diffz_CDC_CDH_pip",100,-1.*TMath::Pi(),TMath::Pi(),100,0,1);
  ...
  pimmom_diffz_CDC_CDH_pim_woK0_wSid = new TH2F("pimmom_diffz_CDC_CDH_pim_woK0_wSid","pimmom_diffz_CDC_CDH_pim_woK0_wSid",100,-1.*TMath::Pi(),TMath::Pi(), 200,0,1);
  ...
  pipmom_diffz_CDC_CDH_pip_woK0_wSid = new TH2F("pipmom_diffz_CDC_CDH_pip_woK0_wSid","pipmom_diffz_CDC_CDH_pip_woK0_wSid",100,-1.*TMath::Pi(),TMath::Pi(), 200,0,1);
  ...
  nmom_diffz_CDC_CDH_pim_woK0_wSid = new TH2F("nmom_diffz_CDC_CDH_pim_woK0_wSid","nmom_diffz_CDC_CDH_pim_woK0_wSid",100,-1.*TMath::Pi(),TMath::Pi(),100,0,1);
  nmom_diffz_CDC_CDH_pim_woK0_wSid->SetXTitle("CDH hit - #pi^{-} track (z) [cm]");
  nmom_diffz_CDC_CDH_pim_woK0_wSid->SetYTitle("nmom.  [GeV/c]");
  
  nmom_diffz_CDC_CDH_pip_woK0_wSid = new TH2F("nmom_diffz_CDC_CDH_pip_woK0_wSid","nmom_diffz_CDC_CDH_pip_woK0_wSid",100,-1.*TMath::Pi(),TMath::Pi(),100,0,1);
  ...
  for ( Int_t i=0; i<nevent; i++ ) {
   ...
   if(NBetaOK && NdEOK){
     ...
     if(!K0rejectFlag){
       IMnpim_IMnpip_dE_wK0->Fill(LVec_pip_n.M(),LVec_pim_n.M());
       nmom_cosn_wK0->Fill(cos_ncdsCM,(*LVec_n).P());
       nmom_cosK0_wK0->Fill(cos_pippimCM,(*LVec_n).P());
       nmom_cosK0n_wK0->Fill(cos_pippim_ncds_CM,(*LVec_n).P());
       K0mom_cosK0_wK0->Fill(cos_pippimCM,LVec_pip_pim.P());
       nmissmom_cosnmiss_wK0->Fill(cos_nmiss,LVec_nmiss.P());
       ...
       nmom_MMnmiss_wK0->Fill(nmiss_mass,(*LVec_n).P());
       diff2d_CDC_CDH_pim_wK0->Fill(diffphipim,diffpim.z());
       diff2d_CDC_CDH_pip_wK0->Fill(diffphipip,diffpip.z());
       if(!SigmaPFlag && !SigmaMFlag){
   ...
   if(NBetaOK && NdEOK && MissNFlag){
     ...
     pipmom_IMpippim_dE_n->Fill(LVec_pip_pim.M(),(*LVec_pip).P());
     pimmom_IMpippim_dE_n->Fill(LVec_pip_pim.M(),(*LVec_pim).P());
     pipmom_IMnpip_dE_n->Fill(LVec_pip_n.M(),(*LVec_pip).P());
     pimmom_IMnpim_dE_n->Fill(LVec_pim_n.M(),(*LVec_pim).P());
     ...
     if(SigmaPcutFlag[sigmacuttype]) {
       nmom_IMnpip_dE_n_Sp->Fill(LVec_pip_n.M(),(*LVec_n).P());
     ...
     if(SigmaMcutFlag[sigmacuttype]){
       nmom_IMnpim_dE_n_Sm->Fill(LVec_pim_n.M(),(*LVec_n).P());
     ...
     IMpippim_DCApipibeam_n->Fill(dca_pipibeam,LVec_pip_pim.M());
     IMnpip_DCApipibeam_n->Fill(dca_pipibeam,LVec_pip_n.M());
     IMnpim_DCApipibeam_n->Fill(dca_pipibeam,LVec_pim_n.M());
     if(SigmaPFlag || SigmaMFlag){
       MMnpip_MMnpim_wSid_n->Fill(LVec_pim_nmiss.M(),LVec_pip_nmiss.M());
       ...
       nmom_cosn_wSid_n->Fill(cos_ncdsCM,(*LVec_n).P());
       nmom_cosnmiss_wSid_n->Fill(cos_nmiss,(*LVec_n).P());
       ...
       pipmom_IMnpipi_wSid_n->Fill(LVec_pip_pim_n.M(),(*LVec_pip).P());
       pimmom_IMnpipi_wSid_n->Fill(LVec_pip_pim_n.M(),(*LVec_pim).P());
     }
     for(int igap=0;igap<ngap;igap++){
       if(SigmaPsideFlag[sidebandtype][igap] || SigmaMsideFlag[sidebandtype][igap]){
         q_IMnpipi_wSid_n_side[igap]->Fill(LVec_pip_pim_n.M(),qkn.P());
   ...
   if(!K0rejectFlag && NBetaOK && NdEOK && MissNFlag){
     nmom_cosn_wK0_n->Fill(cos_ncdsCM,(*LVec_n).P());
     if(cos_nmiss>0.95 ) {
       nmom_cosn_wK0_n_forward->Fill(cos_ncdsCM,(*LVec_n).P());
     }
     IMnpim_IMnpip_dE_wK0_n->Fill(LVec_pip_n.M(),LVec_pim_n.M());
     ...
     nmissmom_cosK0nmiss_wK0_n->Fill(cos_nmiss_pippim_CM,LVec_nmiss.P());
     nmom_K0mom_n->Fill(LVec_pip_pim.P(),(*LVec_n).P());
     nmom_nmissmom_wK0_n->Fill(LVec_nmiss.P(),(*LVec_n).P());
     nmissmom_K0mom_n->Fill(LVec_pip_pim.P(),LVec_nmiss.P());
     ...
     if(!SigmaPFlag && !SigmaMFlag){
       ...
       nmom_IMnpipi_wK0_woSid_n->Fill(LVec_pip_pim_n.M(),(*LVec_n).P());
     }
     
     Mompippim_IMnpipi_dE_wK0_n->Fill(LVec_pip_pim_n.M(),LVec_pip_pim.P());
     Mompippim_nmom_dE_wK0_n->Fill((*LVec_n).P(),LVec_pip_pim.P());
   ...
   if(K0rejectFlag && NBetaOK && NdEOK){
     ...
     MMnmiss_IMpippim_dE_woK0->Fill(LVec_pip_pim.M(),nmiss_mass);
     if(SigmaPFlag || SigmaMFlag){
   ...
   if(K0rejectFlag && NBetaOK && NdEOK && MissNFlag){
     ...
     IMnpip_DCApipibeam_woK0_n->Fill(dca_pipibeam,LVec_pip_n.M());
     IMnpim_DCApipibeam_woK0_n->Fill(dca_pipibeam,LVec_pim_n.M());
     for(int igap=0;igap<ngap;igap++){
       if(SigmaPsideFlag[sidebandtype][igap] || SigmaMsideFlag[sidebandtype][igap]){
     ...
     MMnpip_MMnpim_woK0_n->Fill(LVec_pim_nmiss.M(),LVec_pip_nmiss.M());
     nmom_IMnpim_dE_woK0_n->Fill(LVec_pim_n.M(),(*LVec_n).P());
     nmom_IMnpip_dE_woK0_n->Fill(LVec_pip_n.M(),(*LVec_n).P());
     if(SigmaPFlag || SigmaMFlag){
       MMnpip_MMnpim_woK0_wSid_n->Fill(LVec_pim_nmiss.M(),LVec_pip_nmiss.M());
       ...
       IMpippim_IMnpip_woK0_wSid_n->Fill(LVec_pip_n.M(),LVec_pip_pim.M());    
       IMpippim_IMnpim_woK0_wSid_n->Fill(LVec_pim_n.M(),LVec_pip_pim.M());    
       nmom_cosn_woK0_wSid_n->Fill(cos_ncdsCM,(*LVec_n).P());
       nmom_cosnmiss_woK0_wSid_n->Fill(cos_nmiss,(*LVec_n).P());
       ...
       diff2d_CDC_CDH_pim_woK0_wSid_n->Fill(diffphipim,diffpim.z());
       diff2d_CDC_CDH_pip_woK0_wSid_n->Fill(diffphipip,diffpip.z());
     }
     ...
     if(SigmaPcutFlag[sigmacuttype]) {
       ...
       IMnpip_DCApipibeam_woK0_n_Sp->Fill(dca_pipibeam,LVec_pip_n.M());
       nmom_Momnpip_woK0_n_Sp->Fill(LVec_pip_n.P(),(*LVec_n).P());
       if(SimSpmode){
