...
void K0SigmaTemp()
{
  ...
  */
  ...
  IMpippim_IMnpip_wK0orwSid_n_woSmdia_bin_sub[22][2]->RebinX(4);
  IMpippim_IMnpip_wK0orwSid_n_woSmdia_bin_sub[22][2]->RebinY(4);
  IMpippim_IMnpip_wK0orwSid_n_woSmdia_bin_sub[22][2]->Draw("colz");
  cIMpippim_IMnpip_n_sub_bin22->cd(1);
  TH1D* IMnpip_n_sub_bin22 = (TH1D*)IMpippim_IMnpip_wK0orwSid_n_woSmdia_bin_sub[22][2]->ProjectionX("IMnpip_n_sub_bin22");
  IMnpip_n_sub_bin22->Draw("E");
  cIMpippim_IMnpip_n_sub_bin22->cd(4);
  TH1D* IMpippim_n_sub_bin22 = (TH1D*)IMpippim_IMnpip_wK0orwSid_n_woSmdia_bin_sub[22][2]->ProjectionY("IMpippim_n_sub_bin22");
  IMpippim_n_sub_bin22->Rebin(2);
