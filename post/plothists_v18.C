...
void PhysicsPlots(const char *filename){
  ...
  TCanvas *cIMnpim_IMnpip = new TCanvas("cIMnpim_IMnpip","cIMnpim_IMnpip");
  ...
  TCanvas *cIMnpim_IMnpip_px = new TCanvas("cIMnpim_IMnpip_px","cIMnpim_IMnpip_px");
  ...
  TCanvas *cIMnpim_IMnpip_py = new TCanvas("cIMnpim_IMnpip_py","cIMnpim_IMnpip_py");
