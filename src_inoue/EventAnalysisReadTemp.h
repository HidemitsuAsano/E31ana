...
class EventAnalysisReadTemp : public EventTemp
{
public:
  EventAnalysisReadTemp();
  ~EventAnalysisReadTemp(){};
private:
  int t0, t1;
...
EventAnalysisReadTemp::EventAnalysisReadTemp() : EventTemp()
{
}

bool EventAnalysisReadTemp::UAna(TKOHitCollection *tko)
{
  Event_Number++;
...
void EventAnalysisReadTemp::Initialize(ConfMan *conf)
{
  confMan = conf;
...
bool EventAnalysisReadTemp::cdsFileMatching()
{
...
bool EventAnalysisReadTemp::anaFileMatching()
{
...
bool EventAnalysisReadTemp::Clear(bool flag)
{
  header-> Clear();
  blMan-> Clear();
  cdsMan-> Clear();
...
void EventAnalysisReadTemp::USca(int nsca, unsigned int *sca)
{
  Block_Event_Number++;
...
void EventAnalysisReadTemp::Finalize()
{
  delete blMan;
  delete cdsMan;
  delete cdsHeader;
