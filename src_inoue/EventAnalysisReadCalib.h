...
class EventAnalysisReadCalib : public EventTemp
{
public:
  EventAnalysisReadCalib();
  ~EventAnalysisReadCalib(){};
private:
  int t0, t1;
...
EventAnalysisReadCalib::EventAnalysisReadCalib() : EventTemp()
{
}

bool EventAnalysisReadCalib::UAna(TKOHitCollection *tko)
{
  Event_Number++;
...
void EventAnalysisReadCalib::Initialize(ConfMan *conf)
{
  confMan = conf;
...
bool EventAnalysisReadCalib::cdsFileMatching()
{
...
bool EventAnalysisReadCalib::anaFileMatching()
{
...
bool EventAnalysisReadCalib::Clear(bool flag)
{
  header-> Clear();
  blMan-> Clear();
  cdsMan-> Clear();
...
void EventAnalysisReadCalib::USca(int nsca, unsigned int *sca)
{
  Block_Event_Number++;
...
void EventAnalysisReadCalib::Finalize()
{
  delete blMan;
  delete cdsMan;
  delete cdsHeader;
