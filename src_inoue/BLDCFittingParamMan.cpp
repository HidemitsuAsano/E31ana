...
bool BLDCFittingParamMan::layerdead( const int &id, const int &i )
{
  if( id==CID_BLC1a )      return layerdeadBLC1a(i);
    ...
    std::cout<<"BLDCFittingParamMan::layerdead(): no parameter for id: "<<id<<" and layer: "<<i<<std::endl;
    return false;
  }
}
// + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + //
bool BLDCFittingParamMan::layerkilled( const int &id, const int &i )
{
  if(      id==CID_BLC1a ) return layerkilledBLC1a(i);
    ...
    std::cout<<"BLDCFittingParamMan:layerkilled(): no parameter for id: "<<id<<" and layer: "<<i<<std::endl;
    return false;
  }
}
// + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + //
...
int BLDCFittingParamMan::GetMinHitX( const int &id )
{
  ...
  else if( id==CID_BLC1 ) return GetMinHitXBLC1();
  else if( id==CID_BLC2 ) return GetMinHitXBLC2();
  else if( id==CID_BPC ) return GetMinHitXBPC();
  else if( id==CID_FDC1 ) return GetMinHitXFDC1();
  else{
    std::cout<<"BLDCFittingParamMan::GetMinHitX(): no parameter for id: "<<id<<std::endl;
    return false;
  }
}
// + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + //
int BLDCFittingParamMan::GetMinHitY( const int &id )
{
  ...
  else if( id==CID_BLC1  ) return GetMinHitYBLC1();
  else if( id==CID_BLC2  ) return GetMinHitYBLC2();
  else if( id==CID_BPC ) return GetMinHitYBPC();
  else if( id==CID_FDC1 ) return GetMinHitYFDC1();
  else{
    std::cout<<"BLDCFittingParamMan::GetMinHitY(): no parameter for id: "<<id<<std::endl;
    return false;
  }
}
// + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + -- + //
