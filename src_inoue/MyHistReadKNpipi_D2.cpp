...
void initHistReadKNpipi_D2(EventHeader *header, AnaInfo *anaInfo)
{
  ...
  new TH2F("KNpipi_MM_KN_MM",     "d(K^{-}, n #pi^{+} #pi^{-}", 2000, 0.0, 2.0, 2000, 0.0, 2.0);
  new TH2F("KNpipi_MM_KN_MM_wK0", "d(K^{-}, n #pi^{+} #pi^{-}", 2000, 0.0, 2.0, 2000, 0.0, 2.0);
  new TH2F("KNpipi_MM_KN_MM_wSp", "d(K^{-}, n #pi^{+} #pi^{-}", 2000, 0.0, 2.0, 2000, 0.0, 2.0);
  new TH2F("KNpipi_MM_KN_MM_wSm", "d(K^{-}, n #pi^{+} #pi^{-}", 2000, 0.0, 2.0, 2000, 0.0, 2.0);
