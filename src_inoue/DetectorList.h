...
#endif
{
 public:
  ...
  int CounterID(int i) { return CIDList[CType_Counter][i]; }
  int ChamberID(int i) { return CIDList[CType_Chamber][i]; }
  
  unsigned int nLists()    { return CIDContainer.size(); }
  unsigned int nChambers() { return CIDList[CType_Chamber].size(); }
  unsigned int nCounters() { return CIDList[CType_Counter].size(); }
  unsigned int nMTDCs()    { return CIDList[CType_MTDC].size(); }
  unsigned int nNODETs()   { return CIDList[CType_NODET].size(); }
