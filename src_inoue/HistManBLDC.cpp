...
void HistManBeamAna::initBLDC()
{
  ...
  new TH1F("ntrackBLC1a", "BLC1a ntrack", 10, -0.5, 9.5);
  new TH1F("ntrackBLC1b", "BLC1b ntrack", 10, -0.5, 9.5);
  ...
  new TH2F("ntrackBLC",   "ntrack BLC1 vs ntrackBLC2", 10, -0.5, 9.5, 10, -0.5, 9.5);

  new TH1F("BLC1_time", "BLC1 time", 5000, -200, 300);
  new TH1F("BLC2_time", "BLC2 time", 5000, -200, 300);
  new TH1F("BPC_time",  "BPC time",  5000, -200, 300);
  new TH1F("FDC1_time", "FDC1 time", 5000, -200, 300);

  new TH1F("statusBLC1",  "BLC1 status",  11, -0.5, 10.5);
  new TH1F("statusBLC1a", "BLC1a status", 11, -0.5, 10.5);
  new TH1F("statusBLC1b", "BLC1b status", 11, -0.5, 10.5);
  new TH1F("statusBLC2",  "BLC2 status",  11, -0.5, 10.5);
  new TH1F("statusBLC2a", "BLC2a status", 11, -0.5, 10.5);
  new TH1F("statusBLC2b", "BLC2b status", 11, -0.5, 10.5);
  new TH1F("statusBPC",   "BPC status",   11, -0.5, 10.5);
  new TH1F("statusFDC1",  "FDC1 status",  11, -0.5, 10.5);
  ...
  new TH1F("FDC1_chi2", "FDC1 chi-square", 1000, 0.0, 100);

  new TH1F("BLC1_chi2_w", "BLC1 chi-square", 1000, 0.0, 100);
  new TH1F("BLC2_chi2_w", "BLC2 chi-square", 1000, 0.0, 100);
  new TH1F("BPC_chi2_w",  "BPC chi-square",  1000, 0.0, 100);
  new TH1F("FDC1_chi2_w", "FDC1 chi-square", 1000, 0.0, 100);

  new TH1F("BLC1_chi2_wo", "BLC1 chi-square", 1000, 0.0, 100);
  new TH1F("BLC2_chi2_wo", "BLC2 chi-square", 1000, 0.0, 100);
  new TH1F("BPC_chi2_wo",  "BPC chi-square",  1000, 0.0, 100);
  new TH1F("FDC1_chi2_wo", "FDC1 chi-square", 1000, 0.0, 100);

  new TH1F("BLC1_chi2_good", "BLC1 chi-square", 1000, 0.0, 100);
  new TH1F("BLC2_chi2_good", "BLC2 chi-square", 1000, 0.0, 100);
  new TH1F("BPC_chi2_good",  "BPC chi-square",  1000, 0.0, 100);
  new TH1F("FDC1_chi2_good", "FDC1 chi-square", 1000, 0.0, 100);

  new TH1F("BLC1_chi2_bad", "BLC1 chi-square", 1000, 0.0, 100);
  new TH1F("BLC2_chi2_bad", "BLC2 chi-square", 1000, 0.0, 100);
  new TH1F("BPC_chi2_bad",  "BPC chi-square",  1000, 0.0, 100);
  new TH1F("FDC1_chi2_bad", "FDC1 chi-square", 1000, 0.0, 100);
  ...
  new TH1F("FDC1_lay_eff",  "FDC1 layer efficiency", 7 , -0.5, 7.5);
  ...
  for( int lay=1; lay<=8; lay++ ){
    ...
    new TH1F(Form("BLC1a_dt_%d_track", lay), Form("BLC1a layer%d dt", lay), 500, -100, 400);
    for( int wire=1; wire<=32; wire++ ){
      ...
      new TH1F(Form("BLC1a_dt_%d_%d_track", lay, wire), Form("BLC1a layer%d wire%d dt", lay, wire), 500, -100, 400);
    }
    ...
    new TH1F(Form("BLC1b_dt_%d_track", lay), Form("BLC1b layer%d dt", lay), 500, -100, 400);
    for( int wire=1; wire<=32; wire++ ){
      ...
      new TH1F(Form("BLC1b_dt_%d_%d_track", lay, wire), Form("BLC1b layer%d wire%d dt", lay, wire), 500, -100, 400);
    }
    ...
    new TH1F(Form("BLC2a_dt_%d_track", lay), Form("BLC2a layer%d dt", lay), 500, -100, 400);
    for( int wire=1; wire<=32; wire++ ){
      ...
      new TH1F(Form("BLC2a_dt_%d_%d_track", lay, wire), Form("BLC2a layer%d wire%d dt", lay, wire), 500, -100, 400);
    }
    ...
    new TH1F(Form("BLC2b_dt_%d_track", lay), Form("BLC2b layer%d dt", lay), 500, -100, 400);
    for( int wire=1; wire<=32; wire++ ){
      ...
      new TH1F(Form("BLC2b_dt_%d_%d_track", lay, wire), Form("BLC2b layer%d wire%d dt", lay, wire), 500, -100, 400);
    }
    ...
    new TH1F(Form("BPC_dt_%d_track", lay), Form("BPC layer%d dt", lay), 500, -100, 400);
    for( int wire=1; wire<=15; wire++ ){
      ...
      new TH1F(Form("BPC_dt_%d_%d_track", lay, wire), Form("BPC layer%d wire%d dt", lay, wire), 500, -100, 400);
    }
  }
  ...
  for( int lay=1; lay<=6; lay++ ){
    ...
    new TH1F(Form("FDC1_dt_%d_track", lay),      Form("FDC1 layer%d dt", lay), 500, -100, 400);
    for( int wire=1; wire<=64; wire++ ){
      ...
      new TH1F(Form("FDC1_dt_%d_%d_track", lay, wire), Form("FDC1 layer%d wire%d dt", lay, wire), 500, -100, 400);
    }
  }
...
void HistManBeamAna::fillBLDC(EventHeader *header, BeamLineHitMan *blMan, BeamLineTrackMan *bltrackMan)
{
  ...
  h1 = getTH("statusBLC1"), h1-> Fill(bltrackMan->status(CID_BLC1));
  h1 = getTH("statusBLC1a"), h1-> Fill(bltrackMan->status(CID_BLC1a));
  h1 = getTH("statusBLC1b"), h1-> Fill(bltrackMan->status(CID_BLC1b));
  h1 = getTH("statusBLC2"), h1-> Fill(bltrackMan->status(CID_BLC2));
  h1 = getTH("statusBLC1a"), h1-> Fill(bltrackMan->status(CID_BLC2a));
  h1 = getTH("statusBLC1b"), h1-> Fill(bltrackMan->status(CID_BLC2b));
  h1 = getTH("statusBPC"), h1-> Fill(bltrackMan->status(CID_BPC));
  h1 = getTH("statusFDC1"), h1-> Fill(bltrackMan->status(CID_FDC1));

  h1 = getTH("ntrackBLC1"), h1-> Fill(bltrackMan->ntrackBLC1());
  h1 = getTH("ntrackBLC1a"), h1-> Fill(bltrackMan->ntrackBLC1a());
  h1 = getTH("ntrackBLC1b"), h1-> Fill(bltrackMan->ntrackBLC1b());
  h1 = getTH("ntrackBLC2"), h1-> Fill(bltrackMan->ntrackBLC2());
  h1 = getTH("ntrackBLC2a"), h1-> Fill(bltrackMan->ntrackBLC2a());
  h1 = getTH("ntrackBLC2b"), h1-> Fill(bltrackMan->ntrackBLC2b());
  h1 = getTH("ntrackBPC"), h1-> Fill(bltrackMan->ntrackBPC());
  h1 = getTH("ntrackFDC1"), h1-> Fill(bltrackMan->ntrackFDC1());
  h2 = getTH2("ntrackBLC"), h2-> Fill(bltrackMan->ntrackBLC1(), bltrackMan->ntrackBLC2());

  for( int i=0; i<bltrackMan->ntrackBLC1(); i++ ){
    h1 = getTH("BLC1_time"), h1-> Fill(bltrackMan->trackBLC1(i)->GetTrackTime());
    h1 = getTH("BLC1_chi2"), h1-> Fill(bltrackMan->trackBLC1(i)->chi2all());
    if( -10<bltrackMan->trackBLC1(i)->GetTrackTime() && bltrackMan->trackBLC1(i)->GetTrackTime()<10 ){
      h1 = getTH("BLC1_chi2_good"), h1-> Fill(bltrackMan->trackBLC1(i)->chi2all());
      for( int j=0; j<bltrackMan->trackBLC1(i)->nhit(); j++ ){
	ChamberLikeHit *hit = bltrackMan->trackBLC1(i)->hit(j);
	if( hit->cid()==CID_BLC1a ){
	  h1 = getTH(Form("BLC1a_dt_%d_track", hit->layer())), h1-> Fill(hit->dt());
	}
	else if( hit->cid()==CID_BLC1b ){
	  h1 = getTH(Form("BLC1b_dt_%d_track", hit->layer())), h1-> Fill(hit->dt());
	}
	else{
	  std::cout<<" !!! BLC1 CID Error !!!"<<std::endl;
	}
      }
    }
    else{
      h1 = getTH("BLC1_chi2_bad"), h1-> Fill(bltrackMan->trackBLC1(i)->chi2all());
    }
  }
  for( int i=0; i<bltrackMan->ntrackBLC2(); i++ ){
    h1 = getTH("BLC2_time"), h1-> Fill(bltrackMan->trackBLC2(i)->GetTrackTime());
    h1 = getTH("BLC2_chi2"), h1-> Fill(bltrackMan->trackBLC2(i)->chi2all());
    if( MyTools::IsNoise(bltrackMan->trackBLC2(i)) ){
      h1 = getTH("BLC2_chi2_w"), h1-> Fill(bltrackMan->trackBLC2(i)->chi2all());
    }
    else{
      h1 = getTH("BLC2_chi2_wo"), h1-> Fill(bltrackMan->trackBLC2(i)->chi2all());
    }

    if( -10<bltrackMan->trackBLC2(i)->GetTrackTime() && bltrackMan->trackBLC2(i)->GetTrackTime()<10 ){
      h1 = getTH("BLC2_chi2_good"), h1-> Fill(bltrackMan->trackBLC2(i)->chi2all());
      for( int j=0; j<bltrackMan->trackBLC2(i)->nhit(); j++ ){
	ChamberLikeHit *hit = bltrackMan->trackBLC2(i)->hit(j);
	if( hit->cid()==CID_BLC2a ){
	  h1 = getTH(Form("BLC2a_dt_%d_track", hit->layer())), h1-> Fill(hit->dt());
	}
	else if( hit->cid()==CID_BLC2b ){
	  h1 = getTH(Form("BLC2b_dt_%d_track", hit->layer())), h1-> Fill(hit->dt());
	}
	else{
	  std::cout<<" !!! BLC2 CID Error !!!"<<std::endl;
	}
      }
    }
    else{
      h1 = getTH("BLC2_chi2_bad"), h1-> Fill(bltrackMan->trackBLC2(i)->chi2all());
    }
  }
  for( int i=0; i<bltrackMan->ntrackBPC(); i++ ){
    h1 = getTH("BPC_time"), h1-> Fill(bltrackMan->trackBPC(i)->GetTrackTime());
    h1 = getTH("BPC_chi2"), h1-> Fill(bltrackMan->trackBPC(i)->chi2all());
    if( MyTools::IsNoise(bltrackMan->trackBPC(i)) ){
      h1 = getTH("BPC_chi2_w"), h1-> Fill(bltrackMan->trackBPC(i)->chi2all());
    }
    else{
      h1 = getTH("BPC_chi2_wo"), h1-> Fill(bltrackMan->trackBPC(i)->chi2all());
    }
    if( -10<bltrackMan->trackBPC(i)->GetTrackTime() && bltrackMan->trackBPC(i)->GetTrackTime()<10 ){
      h1 = getTH("BPC_chi2_good"), h1-> Fill(bltrackMan->trackBPC(i)->chi2all());
      for( int j=0; j<bltrackMan->trackBPC(i)->nhit(); j++ ){
	ChamberLikeHit *hit = bltrackMan->trackBPC(i)->hit(j);
	h1 = getTH(Form("BPC_dt_%d_track", hit->layer())), h1-> Fill(hit->dt());
      }
    }
    else{
      h1 = getTH("BPC_chi2_bad"), h1-> Fill(bltrackMan->trackBPC(i)->chi2all());
    }
  }
  for( int i=0; i<bltrackMan->ntrackFDC1(); i++ ){
    h1 = getTH("FDC1_time"), h1-> Fill(bltrackMan->trackFDC1(i)->GetTrackTime());
    h1 = getTH("FDC1_chi2"), h1-> Fill(bltrackMan->trackFDC1(i)->chi2all());
    if( -10<bltrackMan->trackFDC1(i)->GetTrackTime() && bltrackMan->trackFDC1(i)->GetTrackTime()<10 ){
      for( int j=0; j<bltrackMan->trackFDC1(i)->nhit(); j++ ){
	ChamberLikeHit *hit = bltrackMan->trackFDC1(i)->hit(j);
	h1 = getTH(Form("FDC1_dt_%d_track", hit->layer())), h1-> Fill(hit->dt());
      }
    }
  }
  ...
  if( bltrackMan->ntrackBLC1a()==1 ){
    ...
    if( r<7.5 ){
      ...
      if( fBeamPID==Beam_Kaon && fBHD_hit.size()==1 ){
	h1 = getTH("BLC1b_eff"), h1-> Fill(2);
	if( bltrackMan->ntrackBLC1b()>0 ) h1-> Fill(3);
      }
  ...
  if( bltrackMan->ntrackBLC1b()==1 ){
    ...
    if( r<7.5 ){
      ...
      if( fBeamPID==Beam_Kaon && fBHD_hit.size()==1 ){
	h1 = getTH("BLC1a_eff"), h1-> Fill(2);
	if( bltrackMan->ntrackBLC1a()>0 ) h1-> Fill(3);
      }
  ...
  if( bltrackMan->ntrackBLC2a()==1 ){
    ...
    if( r<5 ){
      ...
      if( fBeamPID==Beam_Kaon && fBHD_hit.size()==1 ){
	h1 = getTH("BLC2b_eff"), h1-> Fill(2);
	if( bltrackMan->ntrackBLC2b()>0 ) h1-> Fill(3);
      }
  ...
  if( bltrackMan->ntrackBLC2b()==1 ){
    ...
    if( r<5 ){
      ...
      if( fBeamPID==Beam_Kaon && fBHD_hit.size()==1 ){
	h1 = getTH("BLC2a_eff"), h1-> Fill(2);
	if( bltrackMan->ntrackBLC2a()>0 ) h1-> Fill(3);
      }
