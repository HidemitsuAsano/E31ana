...
set Version="1"
set DSTVersion="1"
set DATADIR="/gpfs/group/had/knucl/e15/asano/sim/simpS0pim${DSTVersion}/"
set CDSDIR="/gpfs/group/had/knucl/e15/asano/sim/simcds/"
set CDSDIRSUB="${CDSDIR}simDSTpS0pim${DSTVersion}"
set OUTDIR="/gpfs/group/had/knucl/e15/asano/sim/simIMLPim_pS0pim/"

set starttime=`date '+%y/%m/%d %H:%M:%S'`
set logbasedir="/home/had/hiasano/logs/"
set date=`date +%Y%m%d_%H%M`
set logdir="${logbasedir}${date}_simIMLpim_pS0pim_${Version}"
...
ln -s $OUTDIRSUB/simIMLpim_all.root simpost/simIMLpim_pS0pim_v${Version}.root
ln -s $OUTDIRSUB/simIMLpim_ppimpim_all.root simpost/simIMLpim_ppimpim_pS0pim_v${Version}.root
...
while ($i < 400)   
  ...
  set CDSFILE=${CDSDIRSUB}"/simDST_pS0pim_0${jobnum}.root"
  ...
  set logname = "${logdir}/runIMLpim_pS0pim$i.log"
