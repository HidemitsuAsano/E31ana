...
{ 
  ...
  bool IsNCHit(BeamLineHitMan *blman);
  ...
  void AnaPipPimCDCCDH(const TVector3 PosCDH,const HodoscopeLikeHit *nhit, const int pip_ID, const int pim_ID, CDSHitMan *cdsman,CDSTrackingMan *trackman);
