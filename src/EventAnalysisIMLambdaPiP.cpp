  ...
  if( pimpipFlag &&
    ...
    if( !nCDCforVeto ){
      ...
      if( GeomTools::GetID(vtx_react)==CID_Fiducial ){
        ...
        if( NeutralBetaCDH<anacuts::beta_MAX && anacuts::dE_MIN<ncdhhit->emean() ){
      ...
      if(K0rejectFlag){
        // K0 rejection
	      Tools::Fill2D( Form("dE_betainv_fiducial_beta_dE_K0"), 1./NeutralBetaCDH, ncdhhit->emean() );
	      Tools::Fill2D( Form("MMom_MMass_fiducial_beta_dE_K0"), mm_mass, P_missn.Mag() );
      }
      if(K0rejectFlag && MissNFlag){
        Tools::Fill2D( Form("dE_betainv_fiducial_beta_dE_K0_n"), 1./NeutralBetaCDH, ncdhhit->emean() );
        Tools::Fill2D( Form("MMom_MMass_fiducial_beta_dE_K0_n"), mm_mass, P_missn.Mag() );
        Tools::Fill2D( Form("MMom_NMom"), P_n.Mag(), P_missn.Mag() );
        Tools::Fill2D( Form("IMnpim_IMnpip"), (L_n+L_pip).M(), (L_n+L_pim).M() );
      }
		  if(K0rejectFlag && MissNFlag && (SigmaPFlag || SigmaMFlag)){
        Tools::Fill2D( Form("IMmnpim_IMmnpip"), (L_nmiss+L_pip).M(), (L_nmiss+L_pim).M() );
        Tools::Fill2D( Form("MMnppip_MMnppim"), (LVec_target+LVec_beam-L_pim-L_n).M(),
            (LVec_target+LVec_beam-L_pip-L_n).M() );

        Tools::Fill2D( Form("Cosn_IMnppipi"), (L_n+L_pim+L_pip).M(), cos_n );
...
//**--**--**--**--**--**--**--**--**--**--**--**--**--**//
{
  ...
  Tools::newTH2F( Form("dE_betainv_fiducial_beta_dE_K0"), 200, 0, 10, 200, 0, 50);
  Tools::newTH2F( Form("dE_betainv_fiducial_beta_dE_K0_n"), 200, 0, 10, 200, 0, 50);
  ...
  Tools::newTH2F( Form("MMom_MMass_fiducial_beta_dE_K0"), 140, 0.4, 1.8, 100, 0, 1.5 );
  Tools::newTH2F( Form("MMom_MMass_fiducial_beta_dE_K0_n"), 140, 0.4, 1.8, 100, 0, 1.5 );
  ...
  Tools::newTH1F( Form("DCA_pip_SigmaP"), 200, 0, 2 );
  Tools::newTH1F( Form("DCA_pim_SigmaP"), 200, 0, 2 );
  Tools::newTH1F( Form("DCA_pip_SigmaM"), 200, 0, 2 );
  Tools::newTH1F( Form("DCA_pim_SigmaM"), 200, 0, 2 );
  Tools::newTH1F( Form("DCA_pippim"), 200, 0, 2);
