...
int main( int argc, char** argv )
{
  ...
  pdg->ReadPDGTable("/home/sakuma/tmp/k18ana/pdg_table.txt");
  ...
  Tools::newTH2F(Form("nIM_Mm_Lp"), 100, 2, 3, 140, 0.4, 1.8);
  Tools::newTH1F(Form("ncosL_Lp"), 100, -1, 1);
  Tools::newTH1F(Form("ncosp_Lp"), 100, -1, 1);
  
  Tools::newTH1F(Form("ncoslabL_Lp"), 100, -1, 1);
  Tools::newTH1F(Form("ncoslabp_Lp"), 100, -1, 1);
  
  Tools::newTH1F(Form("ncosLkpp"), 100, -1, 1);
  Tools::newTH1F(Form("ncospkpp"), 100, -1, 1);

  Tools::newTH1F(Form("nmomL_Lp"), 70, 0, 1.4);
  Tools::newTH1F(Form("nmomp_Lp"), 70, 0, 1.4);
  Tools::newTH1F(Form("ncosOA_Lp"), 800, -1, 1);
  
  Tools::newTH1F(Form("nIM_Lp_Lpn"), 100, 2, 3);		  
  Tools::newTH1F(Form("nIM_Ln_Lpn"), 100, 2, 3);		  
  Tools::newTH1F(Form("nOAlp_Lpn"), 100, -1, 1);
  Tools::newTH1F(Form("nOAln_Lpn"), 100, -1, 1);
  Tools::newTH1F(Form("nOApn_Lpn"), 100, -1, 1);
  Tools::newTH1F(Form("ncosL_Lpn"), 100, -1, 1);
  Tools::newTH1F(Form("ncosp_Lpn"), 100, -1, 1);
  Tools::newTH1F(Form("ncosn_Lpn"), 100, -1, 1);
  Tools::newTH1F(Form("ncoslabL_Lpn"), 100, -1, 1);
  Tools::newTH1F(Form("ncoslabp_Lpn"), 100, -1, 1);
  Tools::newTH1F(Form("ncoslabn_Lpn"), 100, -1, 1);
  
  Tools::newTH1F(Form("nmomL_Lpn"), 70, 0, 1.4);
  Tools::newTH1F(Form("nmomp_Lpn"), 70, 0, 1.4);
  Tools::newTH1F(Form("nmomn_Lpn"), 70, 0, 1.4);
  
  Tools::newTH2F(Form("nIM_Mm_Lpn"), 100, 2, 3, 60, 0.8, 1.1);
  Tools::newTH2F(Form("nIM_OAlp_Lpn"), 100, 2, 3, 100, -1, 1);
  Tools::newTH2F(Form("nIM_OAln_Lpn"), 100, 2, 3, 100, -1, 1);
  Tools::newTH2F(Form("nIM_OApn_Lpn"), 100, 2, 3, 100, -1, 1);
  Tools::newTH2F(Form("nIM_cosL_Lpn"), 100, 2, 3, 100, -1, 1);
  Tools::newTH2F(Form("nIM_cosp_Lpn"), 100, 2, 3, 100, -1, 1);
  Tools::newTH2F(Form("nIM_cosn_Lpn"), 100, 2, 3, 100, -1, 1);
  Tools::newTH2F(Form("nIM_coslabL_Lpn"), 100, 2, 3, 100, -1, 1);
  Tools::newTH2F(Form("nIM_coslabp_Lpn"), 100, 2, 3, 100, -1, 1);
  Tools::newTH2F(Form("nIM_coslabn_Lpn"), 100, 2, 3, 100, -1, 1);
  
  Tools::newTH2F(Form("nIM_qtransn_Lpn"), 100, 2, 3, 100, -0.3, 1.3);
  
  Tools::newTH2F(Form("nIM_momL_Lpn"), 100, 2, 3, 70, 0, 1.4);
  Tools::newTH2F(Form("nIM_momp_Lpn"), 100, 2, 3, 70, 0, 1.4);
  Tools::newTH2F(Form("nIM_momn_Lpn"), 100, 2, 3, 70, 0, 1.4);
  
  
  Tools::newTH1F(Form("nmomL_Lpn_lab"), 70, 0, 1.4);
  Tools::newTH1F(Form("nmomp_Lpn_lab"), 70, 0, 1.4);
  Tools::newTH1F(Form("nmomn_Lpn_lab"), 70, 0, 1.4);
  
  Tools::newTH2F(Form("ndalitz_Lpn"), 48, -0.6, 0.6, 40, 0, 1 );
  Tools::newTH2F(Form("ndalitz2_Lpn"), 48, -0.6, 0.6, 40, 0, 1 );
  Tools::newTH2F(Form("ndalitz_n_Lpn"), 48, -0.6, 0.6, 40, 0, 1 );
  Tools::newTH2F(Form("ndalitz2_n_Lpn"), 48, -0.6, 0.6, 40, 0, 1 );
  Tools::newTH2F(Form("nIM_Tn_Lpn"), 120, 0, 3, 40, 0, 1);
  ...
  Tools::newTH1F(Form("Lpn_gene_costheta_nK_L"), 20, -1, 1);
  Tools::newTH1F(Form("Lpn_kfit_costheta_nK_L"), 20, -1, 1);

  Tools::newTH1F(Form("Lpn_kfit_pvalue"), 100, 0, 1);
  //----------------------------//
  //---  for kinematical fit ---//
  //----------------------------//
  ...
  for( int ev=0; ev<exen; ev++ ){
	...
	TL_gene_CM[i].Boost(-1*boost);
      ...
      Tools::Fill1D("Lpn_gene_costheta_nK_L", costheta_nK_L);
    }
    //##########################//
    //### get G4 information ###//
    //##########################//
    ...
    for( int i=0; i<bltrackMan->ntrackBPC(); i++ ){
      //if( bltrackMan->trackBPC(i)->CheckRange(-30,100) ){ // for data analysis
	nbpc++;
	bpcid = i;
      //}
    }
    ...
    //if( !(bpctrack->CheckRange(-10,10)) || bpctrack->chi2all()>10 ){ // for data analysis
    ...
    for( int i=0; i<bltrackMan->ntrackBLC2(); i++ ){
      //LocalTrack *blc2 = bltrackMan->trackBLC2(i); // for data analysis
      //if( blc2->CheckRange(-30,100) ){ // for data analysis
	nblc2++;
	//if( blc2->CheckRange(-5,5) && bltrackMan->trackBLC2(i)->chi2all()<10 ) blc2id = i; // for data analysis
	...
	continue;
...
#if 0 // for CDC slewing in data analysis
      ...
      //### finalize PID
      //if( !TrackTools::FindMass2C(track, bpctrack, tof, L3_beam.Vect().Mag(), // for CDC slewing in data analysis
	...
	if( flagbprob ){
	  ...
	  if( mm_lp>0.84 && mm_lp<1.04 ){
	    ...
	    TVector3 K_cross_n_kfit = TL_kfit_CM[0].Vect().Cross(TL_kfit_CM[2].Vect()); // K- x n
	    double costheta_nK_pL_kfit = cos(K_cross_n_kfit.Angle(TL_kfit_CM[4].Vect())); // angle btw (K- x n) and (p from Lambda)
	    Tools::Fill1D("Lpn_kfit_costheta_nK_pL", costheta_nK_pL_kfit);

	    TLorentzVector TL_kfit_Lp = TL_kfit[1]+TL_kfit[3]; // L+p
	    kfit_boost = TL_kfit_Lp.BoostVector(); // CM @ L+p
	    for( int i=0; i<6; i++ ){
	      TL_kfit_CM[i] = TL_kfit[i];
	      TL_kfit_CM[i].Boost(-1*kfit_boost);
	    }
	    K_cross_n_kfit = TL_kfit_CM[0].Vect().Cross(TL_kfit_CM[2].Vect()); // K- x n
	    double costheta_nK_L_kfit = cos(K_cross_n_kfit.Angle(TL_kfit_CM[1].Vect())); // angle btw (K- x n) and Lambda
	    Tools::Fill1D("Lpn_kfit_costheta_nK_L", costheta_nK_L_kfit);

	    //--- calc pvalue ---//
	    double pvalue = ROOT::Math::chisquared_cdf_c(kinfitter.getS(), kinfitter.getNDF());
	    Tools::Fill1D("Lpn_kfit_pvalue", pvalue);
	    //cerr<<kinfitter.getS()<<" "<<pvalue<<endl;
